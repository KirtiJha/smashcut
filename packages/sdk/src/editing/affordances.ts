...
import { resolveEditingAffordances, type EditingAffordances } from "@smashcut/core/editing";
import type { SmashCutElement } from "../types.js";
...
type ModelFacts = Pick<SmashCutElement, "text" | "animationIds" | "start">;
