...
//   localStorage.setItem('smashcut-studio:telemetryDisabled','1')
// ---------------------------------------------------------------------------
...
const NOTICE_KEY = "smashcut-studio:telemetryNoticeShown";
...
const SESSION_FIRED_KEY = "smashcut-studio:sessionStartFired";
