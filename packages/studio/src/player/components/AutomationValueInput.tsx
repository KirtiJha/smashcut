...
export function AutomationValueInput({
  ...
  return (
    <input
      ...
      className="sc-automation-value pointer-events-auto absolute rounded-[3px] border border-panel-border-input bg-panel-bg-2 px-1 font-mono text-[9px] text-panel-text-1"
