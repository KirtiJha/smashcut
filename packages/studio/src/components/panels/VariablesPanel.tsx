...
import { isScalarVariableValue as isScalar } from "@smashcut/core/variables";
...
function HandoffFooter({
  ...
  const command = `npx smashcut render ${shellSingleQuote(compPath)} --variables ${shellSingleQuote(json)}`;
  return (
