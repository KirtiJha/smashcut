import type { FrameStatus } from "@smashcut/core/storyboard";
 ...
 * skills/smashcut-core/references/storyboard-format.md § Frame comments.
 */
export const FRAME_COMMENTS_PATH = ".smashcut/frame-comments.json";
