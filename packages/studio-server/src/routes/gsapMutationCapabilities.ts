...
export function resolveGsapWriter(env: { SMASHCUT_GSAP_WRITER?: string }): "recast" | "acorn" {
  const configured = env.SMASHCUT_GSAP_WRITER ?? "recast";
