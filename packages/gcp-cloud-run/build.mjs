#!/usr/bin/env node
/**
 * Build script for @smashcut/gcp-cloud-run (public OSS package).
 *
...
// drops the workspace `paths` overrides so `@smashcut/producer` resolves
