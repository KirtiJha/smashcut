/**
 * `@smashcut/gcp-cloud-run` — Google Cloud Run + Workflows adapter for
 * the SmashCut distributed render pipeline.
 *
 ...
 * is NOT a dependency of `@smashcut/producer`; consumers install it
 * separately.
 */
