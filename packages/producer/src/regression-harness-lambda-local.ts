 ...
 *
 * Drives the OSS `@smashcut/aws-lambda` handler through the exact
...
import { downloadS3ObjectToFile, tarDirectory, untarDirectory } from "@smashcut/aws-lambda";
import { handler } from "@smashcut/aws-lambda/handler";
import type {
  AssembleEvent,
  HandlerDeps,
  PlanEvent,
