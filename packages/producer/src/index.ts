...
// ── Video frame injection (Smashcut-specific hook) ───────────────────────
export { createVideoFrameInjector } from "@smashcut/engine";
...
// types here so callers that pin `@smashcut/producer` don't need a
