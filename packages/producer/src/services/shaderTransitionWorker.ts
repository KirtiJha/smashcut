...
// subpath export of `@smashcut/engine` rather than the package root.
// Rationale:
//
...
//    redirects `@smashcut/engine/shader-transitions` to the same TS
//    source and bundles it inline, so behavior is identical.
import { TRANSITIONS, crossfade } from "@smashcut/engine/shader-transitions";
