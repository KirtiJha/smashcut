...
import { createFrameLookupTable, type ExtractedFrames } from "@smashcut/engine";
...
const PLAN_V2_HASH_PREFIX = "smashcut-plan-manifest-hash-v2\x00";
...
const EXTRACTION_CACHE_COMPLETE_SENTINEL = ".sc-complete";
export const PLAN_V2_MATERIALIZATION_MARKER = ".smashcut-plan-v2.json";
