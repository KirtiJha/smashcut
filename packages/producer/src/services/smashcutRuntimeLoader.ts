...
const SIBLING_MANIFEST_PATH = resolve(PRODUCER_DIR, "smashcut.manifest.json");
const MODULE_RELATIVE_MANIFEST_PATH = resolve(
  PRODUCER_DIR,
  "../../../core/dist/smashcut.manifest.json",
);
...
const MANIFEST_CANDIDATES: readonly string[] = [
  ...
  resolve(process.cwd(), "../core/dist/smashcut.manifest.json"),
  resolve(process.cwd(), "core/dist/smashcut.manifest.json"),
