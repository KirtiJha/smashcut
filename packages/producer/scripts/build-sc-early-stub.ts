/**
 * Build script: compile stubs/sc-early-stub.ts → src/generated/sc-early-stub-inline.ts
 *
 * Run via: bun run scripts/build-sc-early-stub.ts
 * (also called automatically as part of `bun run build`)
 *
 * Output format mirrors packages/core/scripts/build-smashcut-runtime-artifact.ts:
...
const stubEntry = resolve(repoRoot, "stubs/sc-early-stub.ts");
const generatedDir = resolve(repoRoot, "src/generated");
const outPath = resolve(generatedDir, "sc-early-stub-inline.ts");
...
if (!iife) {
  throw new Error("esbuild produced no output for sc-early-stub.ts");
}
...
writeFileSync(
  outPath,
  [
    "// AUTO-GENERATED by scripts/build-sc-early-stub.ts — do not edit",
    `const HF_EARLY_STUB_IIFE: string = ${escaped};`,
    "",
    "/**",
    " * Returns the pre-built SmashCut early stub IIFE as a string constant.",
