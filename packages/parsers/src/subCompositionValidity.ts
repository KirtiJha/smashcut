 ...
 * `@smashcut/parsers` (rather than `@smashcut/core`, where it
 * originated) because `@smashcut/lint` needs it too, and `lint` cannot
 ...
 *
 * `inlineSubCompositions.ts` (in `@smashcut/core`) intentionally stays
