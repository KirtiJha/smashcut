 ...
 * and verifies that window.__smashcut.fitTextFontSize produces
 * correct results with real canvas measureText.
 *
 * Requires: puppeteer (dep of @smashcut/engine)
...
<script>
  ...
  var r3 = window.__smashcut.fitTextFontSize(
  ...
  window.__testResults.exists = typeof window.__smashcut.fitTextFontSize === "function";
</script>
</body></html>`;
  ...
  try {
    ...
    assert(results.exists === true, "fitTextFontSize should exist on window.__smashcut");
    assert(
