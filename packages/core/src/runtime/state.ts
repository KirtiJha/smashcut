...
export type RuntimeState = {
   ...
   * protocol between the parent (`<smashcut-player>`) and this runtime.
   ...
   * audio-mirror loop in `<smashcut-player>` waits for
   ...
   * `packages/player/src/smashcut-player.ts` — leaving it at `2` will
