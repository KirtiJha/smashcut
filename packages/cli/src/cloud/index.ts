...
export type { SmashcutCloudClient } from "./_gen/client.js";
export type { CreateSmashcutRenderRequest, SmashcutRenderDetail } from "./_gen/types.js";

import { SmashcutApiError, SmashcutCloudClient } from "./_gen/client.js";
 ...
 *
 * The decorator catches `SmashcutApiError(status=401)` thrown from
 ...
 */
export async function createCloudClient(): Promise<SmashcutCloudClient> {
  const client = new SmashcutCloudClient({
...
function wrapWith401Retry(client: SmashcutCloudClient): SmashcutCloudClient {
    ...
    get(target, prop, receiver) {
      ...
      return async (...args: unknown[]): Promise<unknown> => {
        try {
          ...
          if (err instanceof SmashcutApiError && err.status === 401) {
