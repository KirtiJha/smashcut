...
// scripts/generate_smashcut_cli_client.py to extend this list.
...
/**
 * Request body for POST /v3/smashcut/renders.
 */
export interface CreateSmashcutRenderRequest {
  /**
   * SmashCut composition .zip — provide as {type: 'url', url: '...'}, {type:
...
/**
 * Response for POST /v3/smashcut/renders.
 */
export interface CreateSmashcutRenderResponse {
  /**
   * SmashCut render identifier — poll GET /v3/smashcut/renders/{render_id}
   * for status.
   */
  render_id: string;
}
...
/**
 * Response for DELETE /v3/smashcut/renders/{render_id}.
 */
export interface DeleteSmashcutRenderResponse {
  /**
 ...
 */
export type SmashcutAspectRatio = "16:9" | "9:16" | "1:1";

/**
 * Detailed SmashCut render resource.
 */
export interface SmashcutRenderDetail {
  /**
   ...
   */
  resolution?: SmashcutResolution | null;
  /**
   * Aspect ratio, if one was set.
   */
  aspect_ratio?: SmashcutAspectRatio | null;
  /**
...
/**
 * Lifecycle status of a SmashCut render.
 */
export type SmashcutRenderStatus = "queued" | "rendering" | "completed" | "failed";
 ...
 */
export type SmashcutResolution = "1080p" | "4k";
