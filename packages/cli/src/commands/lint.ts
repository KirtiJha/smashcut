...
export const examples: Example[] = [
  ["Lint the current project", "smashcut lint"],
  ["Lint a specific directory", "smashcut lint ./my-video"],
  ["Output findings as JSON", "smashcut lint --json"],
  ["Include info-level findings", "smashcut lint --verbose"],
];
...
export default defineCommand({
  ...
  async run({ args }) {
    ...
    // `smashcut lint --json | ...` on Windows silently loses the entire JSON
