...
/**
 * `smashcut cloud list` — page through GET /v3/smashcut/renders.
 *
...
import type { SmashcutRenderDetail } from "../../cloud/index.js";
...
async function fetchAll(
  ...
  const out: SmashcutRenderDetail[] = [];
