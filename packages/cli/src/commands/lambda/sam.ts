/**
 * Thin wrappers around the AWS SAM CLI used by `smashcut lambda deploy`
 * and `smashcut lambda destroy`.
 *
 ...
 *
 * CDK adopters use `SmashcutRenderStack` directly from their own
