...
export const examples: Example[] = [
  ["Run benchmarks with default settings (3 runs)", "smashcut benchmark"],
  ["Run 5 iterations per config", "smashcut benchmark --runs 5"],
  ["Output results as JSON", "smashcut benchmark --json"],
];
...
const FPS_30: import("@smashcut/core").Fps = { num: 30, den: 1 };
const FPS_60: import("@smashcut/core").Fps = { num: 60, den: 1 };
    ...
    try {
      ...
      if (jsonOutput) {
        ...
        errorBox(
          ...
          "Ensure @smashcut/producer is built and linked.",
        );
      }
      failCommand();
    }
