...
import { findMusicAudioSrc, audioRelPathForSrc, serializeBeats } from "@smashcut/core/beats";
...
export const examples: Example[] = [
  ["Generate the beat file for the current project", "smashcut beats"],
  ["Generate for a specific directory", "smashcut beats ./my-video"],
];
