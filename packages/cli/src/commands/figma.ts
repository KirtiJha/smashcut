/**
 * `smashcut figma` — import figma assets, tokens, and components over
...
export const examples: Example[] = [
  [
    ...
    "smashcut figma asset 'https://www.figma.com/design/KEY/T?node-id=1-2'",
  ],
  ["Import as PNG at 2x", "smashcut figma asset KEY:1-2 --format png --scale 2"],
  ["Pull brand tokens into the composition", "smashcut figma tokens KEY"],
  ["Import a frame as an editable HTML component", "smashcut figma component KEY:10-20"],
];

const HELP = `
${c.bold("smashcut figma")} ${c.dim("<subcommand> [args]")}
