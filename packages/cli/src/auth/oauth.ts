 ...
 *
 * The `heygen-oauth-urls.ts` default in `smashcut-internal/demo-next`
 ...
 *
 * Overrides:
 *   - `SMASHCUT_OAUTH_AUTHORIZE_URL`
 *   - `SMASHCUT_OAUTH_TOKEN_URL`
 *   - `SMASHCUT_OAUTH_REVOKE_URL`
 ...
 * `SMASHCUT_OAUTH_CLIENT_ID` env var. Empty string means "not
...
function authorizeEndpoint(): string {
  return process.env["SMASHCUT_OAUTH_AUTHORIZE_URL"] || DEFAULT_AUTHORIZE_URL;
}
function tokenEndpoint(): string {
  return process.env["SMASHCUT_OAUTH_TOKEN_URL"] || DEFAULT_TOKEN_URL;
}
function revokeEndpoint(): string {
  return process.env["SMASHCUT_OAUTH_REVOKE_URL"] || DEFAULT_REVOKE_URL;
}
function deviceAuthorizationEndpoint(): string {
  return process.env["SMASHCUT_OAUTH_DEVICE_URL"] || DEFAULT_DEVICE_AUTHORIZATION_URL;
}
...
export function resolveClientId(): string {
  const override = process.env["SMASHCUT_OAUTH_CLIENT_ID"];
