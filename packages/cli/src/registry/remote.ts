 ...
 *
 * Fetches registry manifests and item files from a Smashcut registry hosted
 ...
 *
 * `<type-dir>` comes from ITEM_TYPE_DIRS in @smashcut/core.
 */
...
const CACHE_DIR = join(homedir(), ".smashcut", "cache");
