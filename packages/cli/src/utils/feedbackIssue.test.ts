...
import { buildIssueUrl, SMASHCUT_REPO_URL } from "./feedbackIssue.js";
...
describe("buildIssueUrl", () => {
  const base = {
    ...
    repoPublicUrl: "https://smashcut.dev/p/abc123",
  ...
  it("encodes the title and includes rating + repro URL in the body", () => {
    ...
    expect(body).toContain("https://smashcut.dev/p/abc123");
