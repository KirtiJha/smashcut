...
```text
--sc-color-grading-ascii
--sc-color-grading-bloom
--sc-color-grading-blur
--sc-color-grading-dither
--sc-color-grading-exposure
--sc-color-grading-intensity
--sc-color-grading-kuwahara
--sc-color-grading-pixelate
--sc-color-grading-lut-intensity
```
...
`--sc-color-grading-intensity` scales the primary correction, wheels, curves,
