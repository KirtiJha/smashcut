...
<DocsVideo
  title="SmashCut video: Storyboard Mini"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/storyboard-mini.mp4#t=0.1"
  loop
/>
...
<CardGroup cols={2}>
  ...
  <Card title="How a SmashCut project works" icon="route" href="/concepts">
