...
<DocsVideo
  title="SmashCut video: Editing Before"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/editing-before.mp4#t=0.1"
  loop
/>
*Before — the untouched composition.*

<DocsVideo
  title="SmashCut video: Editing After"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/editing-after.mp4#t=0.1"
  loop
/>
