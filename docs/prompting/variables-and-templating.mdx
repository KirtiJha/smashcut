...
<DocsVideo
  title="SmashCut video: Validate Variables Default"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/validate-variables-default.mp4#t=0.1"
  loop
/>
*Default variable values.*
<DocsVideo
  title="SmashCut video: Validate Variables Variant"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/validate-variables-variant.mp4#t=0.1"
  loop
/>
...
[`@smashcut/sdk`](/packages/sdk) opens a base template and layers a sparse
...
```bash
smashcut render --output default.mp4
smashcut render --variables '{"ground":"#0d1420","ink":"#c8ff3d"}' --strict-variables --output reskin.mp4
```
...
<CardGroup cols={2}>
  ...
  <Card title="@smashcut/sdk" icon="code" href="/packages/sdk">
