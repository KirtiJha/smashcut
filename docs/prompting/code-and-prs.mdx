...
<AccordionGroup>
  <Accordion title="Changelog roundup">
    ...
    <DocsVideo
      title="SmashCut video: Variant Pr Changelog"
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/variant-pr-changelog.mp4#t=0.1"
      loop
    />
    *Rendered from this prompt with [PR URL] = KirtiJha/smashcut#2092, unedited.*
