...
Both route to the same workflow now; what changes is the brief. "Promo for our site" is a launch — sell it. A neutral walkthrough of a docs site is a tour — say so, and the workflow shows the site's own captured screens instead of pitching. Unsure → start at `/smashcut` and let it route.
...
<DocsVideo
  title="SmashCut video: Variant Launch Script"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/variant-launch-script-v2.mp4#t=0.1"
  loop
/>
