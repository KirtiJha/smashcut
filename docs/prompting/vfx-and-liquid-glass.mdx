...
<DocsVideo
  title="SmashCut video: Validate Device Mockup"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/validate-device-mockup.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Glass Notify"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/glass-notify.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Vfx Shatter"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/vfx-shatter.mp4#t=0.1"
  loop
/>
...
> /motion-graphics 6-second 1920x1080 video. A wordmark logo — "SMASHCUT" in platinum on near-black — settles center-frame, then holds — but keep it alive with a film grain overlay and a slow 3% push-in, plus one shimmer sweep across the wordmark at 4s. Use the `grain-overlay`, `parallax-zoom`, and `shimmer-sweep` registry components. No audio.

<DocsVideo
  title="SmashCut video: Logo Polish"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/logo-polish-v2.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Capstone Region Surface"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/capstone-region-surface.mp4#t=0.1"
  loop
/>
