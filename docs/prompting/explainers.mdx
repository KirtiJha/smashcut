...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/example-explainer.mp4#t=0.1"
  portrait
  loop
/>
...
<DocsVideo
  title="SmashCut video: Variant Explainer Landscape"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/variant-explainer-landscape.mp4#t=0.1"
  loop
/>
