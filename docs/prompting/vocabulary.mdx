...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", margin: "1.25rem 0" }}>
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/ease-power2-out.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/ease-power4-out.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/ease-back-out.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/ease-elastic-out.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/ease-expo-out.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/ease-sine-inout.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", margin: "1.25rem 0" }}>
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-push-in.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-pull-back.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-pan.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-crane.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-whip.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-parallax.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/camera-orbit.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", margin: "1.25rem 0" }}>
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/marker-highlight.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/marker-circle.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/marker-burst.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/marker-scribble.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
  ...
  <figure style={{ margin: 0 }}>
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/marker-sketchout.mp4#t=0.1"
      autoPlay
      muted
      loop
      playsInline
