...
Claude Design uses a different setup. Download [`claude-design-smashcut.md`](https://github.com/KirtiJha/smashcut/blob/main/docs/guides/claude-design-smashcut.md) from GitHub (click the ↓ button), then **attach it to your chat** (don't paste the URL — file attachments produce better output):
...
> Take a look at this GitHub repo https://github.com/KirtiJha/smashcut and explain its uses and architecture to me using `/smashcut`.
