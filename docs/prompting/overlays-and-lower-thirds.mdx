...
<DocsVideo
  title="SmashCut video: Validate Lower Third"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/validate-lower-third.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Overlay Xpost"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/overlay-xpost.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Overlay Spotify Preview"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/overlay-spotify-preview.mp4#t=0.1"
  portrait
  loop
/>
