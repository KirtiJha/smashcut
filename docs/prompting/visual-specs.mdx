...
<DocsVideo
  title="SmashCut video: Spec Showreel"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/spec-showreel.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Spec Command Palette"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/spec-command-palette.mp4#t=0.1"
  loop
/>
*Rendered from the spec above, unedited.*
...
<DocsVideo
  title="SmashCut video: Spec Precision Type"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/spec-precision-type.mp4#t=0.1"
  loop
/>
*Rendered from the spec above, unedited.*
