...
<Note>
  These components are for **composed videos** — captions you author into a SmashCut composition. To add captions to an existing **talking-head MP4**, use the [`/embedded-captions`](/prompting/captions-and-talking-heads) workflow instead: it carries its own catalog of caption identities built around subject matting and occlusion (the caption sits *behind* the speaker), which the composition snippets below don't do.
</Note>
...
<DocsVideo
  title="SmashCut video: Validate Captions Catalog"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/validate-captions-catalog.mp4#t=0.1"
  portrait
  loop
/>
...
<DocsVideo
  title="SmashCut video: Caption Kinetic Slam"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/caption-kinetic-slam.mp4#t=0.1"
  loop
/>
...
<DocsVideo
  title="SmashCut video: Caption Neon Glow"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/caption-neon-glow.mp4#t=0.1"
  loop
/>
...
- ❌ `/smashcut add caption-highlight to my interview.mp4`
...
<DocsVideo
  title="SmashCut video: Capstone Region Material"
  src="https://static.heygen.ai/smashcut-oss/docs/images/prompting/capstone-region-material.mp4#t=0.1"
  loop
/>
