---
title: "@smashcut/shader-transitions"
description: "WebGL shader transitions for SmashCut scenes and compositions."
---

The shader transitions package adds GPU-accelerated scene-to-scene transitions to SmashCut compositions. It captures scene samples, uploads them as WebGL textures, and drives fragment-shader compositing from a GSAP timeline.
...
**Use `@smashcut/shader-transitions` when you need to:**
