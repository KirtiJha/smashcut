---
title: "@smashcut/producer"
description: "Render a SmashCut project from Node.js."
---

`@smashcut/producer` owns the complete render pipeline: compile the project,
...
local script or terminal workflow, use [`npx smashcut render`](/developers/cli)
instead.
...
For larger workloads, the `@smashcut/producer/distributed` entry exposes the
...
<CardGroup cols={2}>
  ...
  <Card title="@smashcut/engine" icon="gear" href="/packages/engine">
