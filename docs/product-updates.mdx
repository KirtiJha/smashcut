...
description: "The SmashCut changes that matter when you create, edit, and render projects."
---
...
Scaffolded projects can pin a SmashCut version for reproducibility. Ask your agent to check the project before render-affecting work, or run:
