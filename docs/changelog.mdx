---
title: "Changelog"
description: "Release notes for SmashCut."
rss: true
---

Recent SmashCut releases, including user-facing features, fixes, and migration notes.

{/* New release entries are prepended by `bun run changelog:draft <version> --write`. */}
<Update
  label="SmashCut v0.8.33"
...
<Update
  label="SmashCut v0.8.22"
  description="Released - 2026-09-01"
  tags={["Release", "Rendering", "CLI"]}
>
SmashCut now reports host-interrupted FFmpeg work as retryable instead of a terminal render failure.
...
<Update
  label="SmashCut v0.8.14"
  description="Released - 2026-08-24"
  tags={["Release", "CLI", "Skills,lint"]}
>
Agent skills no longer teach composition rules the renderer does not enforce, four of which used to make a render fail outright. `smashcut add` now records what it installed in `smashcut.json`, so a render can report which catalog blocks the video used.
...
- **Core:** Remove `window.__sc.setAudioSolo`. Custom Studio integrations must stop calling this preview bridge ([05affaae2](https://github.com/heygen-com/hyperframes/commit/05affaae2175a6dde0e2eafa5e702b67863d721c), [#3454](https://github.com/heygen-com/hyperframes/pull/3454)).
...
- **Audio:** Document submix buses, group attributes, routing rules, and carve guardrails in the SmashCut skills and contributor guidance ([2685c8f22](https://github.com/heygen-com/hyperframes/commit/2685c8f2231e39da31871f25b2e4609551a78c76), [#3455](https://github.com/heygen-com/hyperframes/pull/3455)).

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.8.11...v0.8.12).
</Update>

<Update
  label="SmashCut v0.8.11"
...
- **Engine:** Renders no longer finish with the drawElement self-check silently
  ...
  ffmpeg built without it made every comparison fail quietly. SmashCut now
...
- **Skills:** The voiceover carve command now runs in your own project. It could
  not load SmashCut from a published install at all, and the error it printed
...
- **CLI:** Surface SMASHCUT_BROWSER_PATH hint on Windows chrome-headless-shell launch crashes ([7563b644a](https://github.com/heygen-com/hyperframes/commit/7563b644a2f5c4f8b6787b2b088695219aaf9419), [#2481](https://github.com/heygen-com/hyperframes/pull/2481)).
...
<Update
  label="SmashCut v0.8.1"
  description="Released - 2026-08-18"
  tags={["Release", "Docs", "Studio", "Add"]}
>
Variables you pass to `smashcut add` now reach the file it installs, instead of being dropped without a word. Studio also asks for FFmpeg before an export starts, rather than after one fails.
...
<Update
  label="SmashCut v0.8.0"
  description="Released - 2026-08-17"
  tags={["Release", "Cloud", "Migration", "Catalog"]}
>
SmashCut 0.8 establishes the supported version boundary for Plan v2 as the default distributed cloud transport.
...
- **Core:** Expose pretext text measurement on window.__smashcut ([0285a711e](https://github.com/heygen-com/hyperframes/commit/0285a711e926a592bd189d647474b50de474581c), [#3302](https://github.com/heygen-com/hyperframes/pull/3302)).
...
- **Skills:** Add /smashcut-audio, and key the waveform cache by file ([56d8df65c](https://github.com/heygen-com/hyperframes/commit/56d8df65ca0314f0089c366335c19cbf224546e2), [#3211](https://github.com/heygen-com/hyperframes/pull/3211)).
...
- **Examples:** More hover-audio + a 'Where SmashCut plugs in' strip ([59a2ee31c](https://github.com/heygen-com/hyperframes/commit/59a2ee31c93818ce06c8575af4043948f0404a34)).
...
- Upgrade the SmashCut producer fleet to v0.7.90 before deploying callers that send `outputDynamicRange`; the legacy `hdrMode` field remains accepted only to bridge the rolling deployment.
...
- Add THU-MAIC as SmashCut adopter ([1738b5a11](https://github.com/heygen-com/hyperframes/commit/1738b5a11f7eee1c130b29b3c489f79473e7aec2), [#2761](https://github.com/heygen-com/hyperframes/pull/2761))
...
explicit SmashCut browser-path environment overrides and retries transient launch failures
...
<Update
  label="SmashCut v0.7.81"
  description="Released - 2026-07-29"
  tags={["Release", "Producer"]}
>
SmashCut now retries transient Google Fonts CSS and font-file failures during distributed
...
<Update
  label="SmashCut v0.7.80"
  description="Released - 2026-07-29"
  tags={["Release", "Studio"]}
>
SmashCut now renders scene-local video timing correctly across sequential nested templates
...
- **CLI:** Persist authoring skill in smashcut.json for durable render attribution ([d287e5244](https://github.com/heygen-com/hyperframes/commit/d287e5244c1e6d9051642f94f368ef7a1e26bd34), [#2762](https://github.com/heygen-com/hyperframes/pull/2762))
...
<Update
  label="SmashCut v0.7.69"
  description="Released - 2026-07-23"
  tags={["Release", "Sdk", "Lint", "Producer"]}
>
SmashCut now catches rotation pivot drift during layout audits, helping surface off-center spinners before render. This release also preserves editable \<br\> line breaks in SDK text edits, strengthens producer font, probe, and worker-memory handling, and improves preflight and pre-commit feedback.
...
- **Engine:** Reuse SmashCut browser cache ([f0aee2855](https://github.com/heygen-com/hyperframes/commit/f0aee285516d4030268fba6372db446f717246e2), [#2459](https://github.com/heygen-com/hyperframes/pull/2459))
...
- **CLI:** Surface SMASHCUT_BROWSER_PATH hint on macOS \<13 chrome-headless-shell dyld crash ([0d16f19b0](https://github.com/heygen-com/hyperframes/commit/0d16f19b07b1c7f60d54cac4f05f93ea3abacbcd))
...
- **Guides:** Add Claude Design → Send to SmashCut single-file import guide ([5e78a29af](https://github.com/heygen-com/hyperframes/commit/5e78a29af335ecda5e5c8a8400064419a7fcb37e), [#2131](https://github.com/heygen-com/hyperframes/pull/2131))
...
- **CLI:** Smashcut upgrade --project bumps pinned package.json scripts ([c1b1c729e](https://github.com/heygen-com/hyperframes/commit/c1b1c729e52d1787f65d591363bd13f5587e0692))
...
- **CLI:** Surface SMASHCUT_BROWSER_PATH hint on pinned browser download failures ([fd02e6efc](https://github.com/heygen-com/hyperframes/commit/fd02e6efc9b9155252c2a3486dbd2d3826d6719e))
...
- **CLI:** Stable public URL for smashcut publish (re-publish updates the same link) ([4495cb735](https://github.com/heygen-com/hyperframes/commit/4495cb7355bcbb401bcaa04355c817220ef0be48), [#2363](https://github.com/heygen-com/hyperframes/pull/2363))
...
- **Smashcut Media:** Surface the real reason a TTS line failed [P2] ([9c98c1e82](https://github.com/heygen-com/hyperframes/commit/9c98c1e82ab6b27cd6b5025254539a7f7026b1b3), [#1999](https://github.com/heygen-com/hyperframes/pull/1999))
...
<Update
  label="SmashCut v0.7.48"
  description="Released - 2026-07-10"
  tags={["Release", "CLI"]}
>
Prevents slow Chrome downloads from losing their install lock and colliding with another SmashCut process. Also restores `smashcut tts --text-file` compatibility for existing skills and scripts.
...
<Update
  label="SmashCut v0.7.46"
  description="Released - 2026-07-09"
  tags={["Release", "Sdk", "Sdk Playground", "Studio Server"]}
>
Adds live-DOM sync and variable CRUD to `@smashcut/sdk`, plus mechanical Figma motion translation with an objective fidelity gate. Also ships several render-pipeline and parser fixes (cross-realm position edits, static-frame dedup call-detection, GSAP position holds).
...
- **Media Use:** V2 media OS core (resolve cascade, providers, local generation, telemetry) + retire smashcut-media ([5fe957363](https://github.com/heygen-com/hyperframes/commit/5fe957363d2be6d04f4a002fea965dbcc2bd633b))
...
- **CLI:** Parakeet ASR engine for transcribe (--engine) + SMASHCUT_PYTHON override ([8c3590a90](https://github.com/heygen-com/hyperframes/commit/8c3590a90e4be76593ef7554a805004af789b373))
...
- **Parsers,sdk,studio Server,studio:** Unify sc-id space across preview, disk, and SDK session ([3a717fa71](https://github.com/heygen-com/hyperframes/commit/3a717fa71997477c6f81dce7c9f2e63a4ad675ed), [#1981](https://github.com/heygen-com/hyperframes/pull/1981))
...
<Update
  label="SmashCut v0.7.37"
  description="Released - 2026-07-06"
  tags={["Release", "Lambda", "Sdk,studio", "Smashcut Media"]}
>
...
- **Smashcut Media:** Surface a clear error when npx can't be resolved on Windows ([dfa6fedbc](https://github.com/heygen-com/hyperframes/commit/dfa6fedbcdaf8478b4be99d907d88fd079d9bc0a), [#1961](https://github.com/heygen-com/hyperframes/pull/1961))
...
<Update
  label="SmashCut v0.7.36"
  description="Released - 2026-07-05"
  tags={["Release", "CLI"]}
>
This release closes the remaining Windows FFmpeg path gap by making CLI preflight
choose real `ffmpeg.exe`/`ffprobe.exe` binaries over shell shims. `smashcut
render` now avoids exporting `ffmpeg.cmd` as `SMASHCUT_FFMPEG_PATH`, keeping
...
<Update
  label="SmashCut v0.7.35"
  description="Released - 2026-07-05"
  tags={["Release", "Lambda", "Engine", "Smashcut Media"]}
>
...
- **Smashcut Media:** Skip and report offline SFX entries whose bundled file is missing ([b34e623b](https://github.com/heygen-com/hyperframes/commit/b34e623bf8c5fb2ae9608edf1908c466584d627e))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.7.34...v0.7.35).
</Update>

<Update
  label="SmashCut v0.7.34"
  description="Released - 2026-07-05"
  tags={["Release", "Engine"]}
>
...
<Update
  label="SmashCut v0.7.32"
  description="Released - 2026-07-04"
  tags={["Release", "Smashcut Media", "CLI", "Video Workflows"]}
>
This release hardens the CLI validation and browser-install paths: validate now seeks through the runtime player, honors the configured timeout more consistently, and browser installs recover from stale or partial downloads without racing concurrent forced reinstalls. It also closes Windows media setup gaps, scopes `window.__smashcut` correctly inside sub-compositions, pads transition-tail frame durations, and moves large audio filter graphs out of the command line.

## Fixes

- **Smashcut Media:** Install MusicGen deps via python3 -m pip, not bare pip ([942080fa8](https://github.com/heygen-com/hyperframes/commit/942080fa8e8e77de93ef6546690b5b5421d80e88), [#1894](https://github.com/heygen-com/hyperframes/pull/1894))
- **Smashcut Media:** Resolve python3 -\> python/py on Windows ([3388635f1](https://github.com/heygen-com/hyperframes/commit/3388635f1d1431de0b2a2e7d132f834f7614557c), [#1922](https://github.com/heygen-com/hyperframes/pull/1922))
...
<Update
  label="SmashCut v0.7.29"
  description="Released - 2026-07-04"
  tags={["Release", "Skills", "Studio", "Core,cli"]}
>
This release ships the Figma integration: import Figma frames as frozen assets, pull brand variables and styles as composition tokens, convert frames to editable brand-linked HTML components, and translate Figma Motion timelines into seekable GSAP — all routed through the new /figma skill and `smashcut figma` CLI. It also lands a wave of engine extraction-performance work (caching, dedup, one-pass VFR/HDR) and studio persist-failure hardening.
...
<Update
  label="SmashCut v0.7.27"
  description="Released - 2026-07-03"
  tags={["Release", "Capture", "Smashcut Media", "Producer"]}
>
...
- **Smashcut Media:** Npx spawn without shell:true fails silently on Windows ([3b6791824](https://github.com/heygen-com/hyperframes/commit/3b67918242ab0d74b37241b059fa54a792977067), [#1845](https://github.com/heygen-com/hyperframes/pull/1845))
- **Smashcut Media:** Fall back to ffmpeg when ffprobe is missing ([e2b43583f](https://github.com/heygen-com/hyperframes/commit/e2b43583fc2480aa9511cd5e606a58841c4f211e), [#1877](https://github.com/heygen-com/hyperframes/pull/1877))
- **Smashcut Media:** Cap TTS synthesis concurrency instead of firing every line at once ([2e9a33ca7](https://github.com/heygen-com/hyperframes/commit/2e9a33ca719a2b28bd8bb51083df32b8f74ca437), [#1862](https://github.com/heygen-com/hyperframes/pull/1862))
...
- **Skills:** Make smashcut package version resolution non-fatal and overridable ([060889f84](https://github.com/heygen-com/hyperframes/commit/060889f84c430ad8d8d90fe1b7fd74ef4485a705), [#1825](https://github.com/heygen-com/hyperframes/pull/1825))
...
- **Sdk:** Pin editing-affordances availability to @smashcut/sdk@0.7.22 ([9140ee51b](https://github.com/heygen-com/hyperframes/commit/9140ee51b3109b97346cda083714e0b13b1270cf))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.7.22...v0.7.23).
</Update>

<Update
  label="SmashCut v0.7.22"
...
- **Skills:** Instruct agents to run `smashcut feedback` after render ([04700ea9](https://github.com/heygen-com/hyperframes/commit/04700ea9c51d6b29f8512e2ae4c2655054acf20b), [#1785](https://github.com/heygen-com/hyperframes/pull/1785))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.7.20...v0.7.21).
</Update>

<Update
  label="SmashCut v0.7.20"
  description="Released - 2026-06-30"
  tags={["Release", "Producer,lint", "Producer", "Core"]}
>
This release fixes a render-correctness bug where a video or audio element identified only by a `data-sc-id` (no real `id`) rendered as a blank white wash with dropped audio. It also restores Studio keyframe retiming (drag-to-retime and Move to Playhead) and ships capture and runtime reliability improvements.
...
<Update
  label="SmashCut v0.7.19"
  description="Released - 2026-06-29"
  tags={["Release", "Core", "Studio", "Skills"]}
>
This release fixes the `@smashcut/core` package by publishing the generated
...
through `smashcut preview` so coding agents can inspect and edit the active
...
<Update
  label="SmashCut v0.7.17"
  description="Released - 2026-06-27"
  tags={["Release"]}
>
`@smashcut/lint` can now run **fully in the browser** — validate compositions client-side with no Node.js and no server round-trip — and it now depends only on `@smashcut/parsers`, so installing the validator no longer pulls the studio server or other unrelated packages.

## Features

- **Lint:** New `@smashcut/lint/browser` entry — a node-free, client-side rule engine (`lintHyperframeHtml`, `lintMediaUrls`, `shouldBlockRender`) for browser-only editors and tools ([6aaab32c](https://github.com/heygen-com/hyperframes/commit/6aaab32ccb4de355abca8310c2d4fd69ea95e47b), [#1773](https://github.com/heygen-com/hyperframes/pull/1773))

## Internal

- **Lint:** Depend only on `@smashcut/parsers` (dropped `@smashcut/core`); relocated the shared URL/asset-path, font-alias, and slideshow-parser utilities into `@smashcut/parsers` with back-compat stubs in core, and hardened the CSS `url()` regex against polynomial-ReDoS ([6aaab32c](https://github.com/heygen-com/hyperframes/commit/6aaab32ccb4de355abca8310c2d4fd69ea95e47b), [#1773](https://github.com/heygen-com/hyperframes/pull/1773))
...
<Update
  label="SmashCut v0.7.15"
  description="Released - 2026-06-27"
  tags={["Release", "CLI"]}
>
This CLI release keeps `smashcut init` on the GitHub-backed skills
...
- Extract @smashcut/studio-server from core ([7a4853df](https://github.com/heygen-com/hyperframes/commit/7a4853dfe6e7e55effca57314011cec322c13a23), [#1757](https://github.com/heygen-com/hyperframes/pull/1757))
- Extract @smashcut/lint from core ([98d0bdd7](https://github.com/heygen-com/hyperframes/commit/98d0bdd73c7551abeb6962bd82eedc1c44e3d953), [#1756](https://github.com/heygen-com/hyperframes/pull/1756))
- Extract @smashcut/parsers from core ([cdf9c817](https://github.com/heygen-com/hyperframes/commit/cdf9c817e1c0c396a5c24c75ea08a8dba72e3528), [#1755](https://github.com/heygen-com/hyperframes/pull/1755))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.7.14...v0.7.15).
</Update>

<Update
  label="SmashCut v0.7.14"
  description="Released - 2026-06-27"
  tags={["Release", "CLI"]}
>
This CLI release makes SmashCut skills self-healing: installs now keep a
freshness manifest, install once globally, and mirror only SmashCut-owned
...
producer can resolve them. It also keeps SmashCut skills installs targeted to
the agents a project actually uses and adds a product-launch video skill.

## Features

- **Skills:** Product-launch-video skill + consolidate motion knowledge into smashcut-animation ([05af482f](https://github.com/heygen-com/hyperframes/commit/05af482f22a3df534c38056f7d7894b9e469d655), [#1745](https://github.com/heygen-com/hyperframes/pull/1745))
...
<Update
  label="SmashCut v0.7.5"
  description="Released - 2026-06-24"
  tags={["Release", "Player", "Producer"]}
>
This stable release fixes cross-origin player readiness so hosted SmashCut
...
- **Skills:** Register music-to-video in the smashcut router ([44b04324](https://github.com/heygen-com/hyperframes/commit/44b04324b1576d80a2fb5a1bdf8dda0fd049a6ff))
...
<Update
  label="SmashCut v0.6.121"
  description="Released - 2026-06-21"
  tags={["Release", "CLI"]}
>
This hotfix restores `smashcut skills` on Windows by invoking npm's `npx.cmd`
...
<Update
  label="SmashCut v0.6.120"
  description="Released - 2026-06-21"
  tags={["Release", "Shader Transitions"]}
>
This hotfix restores Node-compatible package entrypoints for published SmashCut
...
<Update
  label="SmashCut v0.6.117"
  description="Released - 2026-06-20"
  tags={["Release", "Core"]}
>
This hotfix restores the published `@smashcut/core` subpath contract used by Studio,
...
<Update
  label="SmashCut v0.6.115"
  description="Released - 2026-06-20"
  tags={["Release", "Slideshow", "Core", "Core,studio"]}
>
Full slideshow stack: schema, parser, controller, `<smashcut-slideshow>` web component, presenter mode, branching editor panel, and `smashcut present` CLI command. SDK gains element add/remove ops, elastic timing, keyframe writers, variables/brand model, and image-alpha hit-testing. Fixes cross-realm iframe media handling, per-element audio muting, querySelector injection, and DOM edit parity.
...
- **Player:** \<smashcut-slideshow\> web component + presenter ([075302cd](https://github.com/heygen-com/hyperframes/commit/075302cd0312e0c14f049d50f011c958140af540), [#1590](https://github.com/heygen-com/hyperframes/pull/1590))
...
- **Player:** Slideshow controller + \<smashcut-slideshow\> component ([7af3eb8f](https://github.com/heygen-com/hyperframes/commit/7af3eb8f80945e880138570d49aee585a5346e19), [#1581](https://github.com/heygen-com/hyperframes/pull/1581))
...
- **Sdk:** AddElement forward op — mint sc-id, inverse = removeElement (WS-D) ([0ca01c88](https://github.com/heygen-com/hyperframes/commit/0ca01c88cfbaedad3a5493a8185e37eb7559fdb7), [#1571](https://github.com/heygen-com/hyperframes/pull/1571))
...
- **Publish:** Publish @smashcut/sdk to npm ([7607a714](https://github.com/heygen-com/hyperframes/commit/7607a714a6c46407bb42cff1ed754ea8997035df), [#1587](https://github.com/heygen-com/hyperframes/pull/1587))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.6.112...v0.6.115).
</Update>

<Update
  label="SmashCut v0.6.114"
  description="Released - 2026-06-19"
  tags={["Release", "Slideshow", "Examples", "Skill"]}
>
Adds slideshow support end-to-end: a player-side controller state machine and `<smashcut-slideshow>` web component, a Studio branching-editor panel with manifest persistence, plus authoring-skill guidance and example decks.
...
- **SDK:** Resolve composition-id targets and emit canonical `data-sc-id` for GSAP tweens ([6e3214233](https://github.com/heygen-com/hyperframes/commit/6e3214233), [#1526](https://github.com/heygen-com/hyperframes/pull/1526))
...
- **CLI:** Restore `smashcut capture \<url\>`; move video download to `--video` flag ([f8d9f512](https://github.com/heygen-com/hyperframes/commit/f8d9f51245908d64b74a8df96bc80e901fd1f5cf))
...
- Reconcile skills surface; rename read-first entry skill to /smashcut ([3b3ece81](https://github.com/heygen-com/hyperframes/commit/3b3ece81d1a0b36038e67e58d9ca620e4a3122e9), [#1461](https://github.com/heygen-com/hyperframes/pull/1461))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.6.99...v0.6.100).
</Update>

<Update
  label="SmashCut v0.6.99"
  description="Released - 2026-06-15"
  tags={["Release", "Sdk", "CLI", "Core"]}
>
Introduces the SmashCut SDK (session API, undo/redo, adapters, sub-composition scoped IDs), per-property-group keyframes with gesture recording and beat-snapping, batch rendering with variables, and the acorn-based GSAP parser.
...
- **Sdk:** Scaffold @smashcut/sdk — engine layer (model, RFC 6902 patches, mutate, apply-patches) ([22bb6737](https://github.com/heygen-com/hyperframes/commit/22bb6737c546e910bfdc0bbe6f459bfe01e6bfa6), [#1324](https://github.com/heygen-com/hyperframes/pull/1324))
- **Core:** Expose sc-ids as subpath export for @smashcut/sdk ([2c64f996](https://github.com/heygen-com/hyperframes/commit/2c64f9969442914a2a8813cc60e5e57646742336), [#1323](https://github.com/heygen-com/hyperframes/pull/1323))
...
- **README:** Swap hero media to smashcut-logo-motion ([8fcbb63a](https://github.com/heygen-com/hyperframes/commit/8fcbb63a371752932027f3495dbc6ae6b5daf0f7), [#1315](https://github.com/heygen-com/hyperframes/pull/1315))
...
- **Core:** SourceMutation data-sc-id targeting (R1, T7) ([1cd4ad6a](https://github.com/heygen-com/hyperframes/commit/1cd4ad6ab8d7a0979a79ce5557cc28b8a2e5e99d), [#1272](https://github.com/heygen-com/hyperframes/pull/1272))
- **Studio:** SourcePatcher data-sc-id targeting (R1, T3) ([42c247d2](https://github.com/heygen-com/hyperframes/commit/42c247d28fc1d40feb21f739a28631008bb21280), [#1271](https://github.com/heygen-com/hyperframes/pull/1271))
- **Core:** Clip-model hf- ids minted at parse, emitted as data-sc-id (R1) ([8d6b7cf5](https://github.com/heygen-com/hyperframes/commit/8d6b7cf51574bab44226620879baac2cfeab6cfe), [#1270](https://github.com/heygen-com/hyperframes/pull/1270))
...
- **Core:** Re-register sc-timelines-built listener in maybePublishRenderReady ([1bcd6ec3](https://github.com/heygen-com/hyperframes/commit/1bcd6ec3b3544f1e6c114f7c65b408bbba581db5), [#1279](https://github.com/heygen-com/hyperframes/pull/1279))
...
<Update
  label="SmashCut v0.6.81"
  description="Released - 2026-06-07"
  tags={["Release", "Gcp Cloud Run", "Core", "Registry"]}
>
Adds Google Cloud Run + Cloud Workflows as a distributed-render target (`@smashcut/gcp-cloud-run`) — the GCP counterpart to the AWS Lambda adapter, sharing the same `plan → renderChunk → assemble` primitives. Also lands a font-resolution pipeline so compositions capture and embed their own fonts for deterministic rendering.
...
- Add reap as SmashCut adopter ([4b51cc64](https://github.com/heygen-com/hyperframes/commit/4b51cc646861cbdc00fd67856deb2993eb2eb874), [#876](https://github.com/heygen-com/hyperframes/pull/876))

[View the full commit range](https://github.com/heygen-com/hyperframes/compare/v0.6.73...v0.6.76).
</Update>

<Update
  label="SmashCut v0.6.74"
