---
title: "How a SmashCut project works"
sidebarTitle: "Project model"
description: "Understand the editable files, compositions, timing, and tools behind a SmashCut video."
---

A SmashCut project is a folder your agent can create and you can keep
editing. Its HTML is the video: it describes the scenes, timing, motion, media,
and reusable parts that SmashCut plays or renders.
...
<div style={{ maxWidth: "42rem", margin: "1.5rem auto" }}>
  <Frame caption="The same editable project open in Studio, with its source, canvas, controls, and timeline.">
    <img
      ...
      alt="A SmashCut project open in Studio with the source tree, canvas, controls, and timeline"
    />
  </Frame>
</div>
...
├── smashcut.json      project settings
...
SmashCut seeks the composition to an exact time, captures the frame, and
