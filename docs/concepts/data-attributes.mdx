...
description: "Place clips on the SmashCut timeline without putting timing logic in JavaScript."
---

SmashCut keeps timing in HTML. A timed element normally needs a stable ID,
