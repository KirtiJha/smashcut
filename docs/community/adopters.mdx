---
title: Adopters
description: Organizations using SmashCut in production or actively evaluating it.
---

The teams below use SmashCut in production or are actively evaluating it. If your organization uses SmashCut — in production, in evaluation, or in a side project — we'd love to add you.

## How to add your organization

Open a pull request that adds your team to [`ADOPTERS.md`](https://github.com/KirtiJha/smashcut/blob/main/ADOPTERS.md) at the repository root. The format is intentionally lightweight:

- **Organization** — your company or project name, linked to your website.
- **Contact** — a GitHub handle so other adopters can reach out.
- **How SmashCut is used** — one sentence on the use case.
...
## Teams using or evaluating SmashCut
...
<CardGroup cols={2}>
  ...
  <Card title="TanStack" href="https://tanstack.com">
    ...
    Exploring SmashCut for short-form code demo videos and documentation.
  ...
  <Card title="OptinMonster" href="https://optinmonster.com">
    ...
    Exploring SmashCut for marketing and product video content.
  ...
  <Card title="THU-MAIC" href="https://github.com/THU-MAIC">
    ...
    Powers OpenMAIC's one-click MP4 export for AI-generated interactive classrooms using self-contained SmashCut compositions.
  ...
  <Card title="Mini Course Generator" href="https://minicoursegenerator.com/">
    ...
    Uses SmashCut for AI-composed videos in its course creation workflow.
...
The HeyGen team's actual launch-video sources (the ones featured in product announcements) live at [smashcut-launches](https://github.com/heygen-com/hyperframes-launches) — see [Examples](/examples) for the writeup.
