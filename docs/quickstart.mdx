...
description: "Install the SmashCut skills, make one short request, and continue with your agent, Studio, or the CLI."
---
...
<div className="sc-docs-video-frame">
  <DocsVideo
    title="A beginner creates a first SmashCut video from one short request, then continues with an agent, Studio, or the CLI."
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/journey-quickstart-v5-v2.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/journey-quickstart-v5.jpg"
  />
</div>

<Note>
  SmashCut is free and open-source, and local rendering does not use HeyGen credits. Your coding
...
```text
Set this folder up for SmashCut and make me a video.

1. Run: npx smashcut skills update
2. Then, using /smashcut, make a 10-second product intro for https://example.com
...
To reopen that preview later, run `npx smashcut preview` inside the project
