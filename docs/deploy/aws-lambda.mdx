...
| SmashCut repo checkout | `lambda deploy` builds the Lambda handler ZIP from source. Adopters who deploy outside a checkout can set `SMASHCUT_REPO_ROOT` to point at one. | `git clone https://github.com/KirtiJha/smashcut` |
