...
description: How SmashCut keeps alpha-only work out of stable releases.
---

SmashCut publishes two release channels:
...
```bash
npm install smashcut@alpha
npm install @smashcut/core@alpha
```
