...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-shatter.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-shatter.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add vfx-shatter" item="vfx-shatter" />
      ...
      >
        <section class="panel" id="panel-b" data-panel-b style="width: 1920px; height: 1080px">
          <div class="panel-b-inner">
            ...
            <div class="pb-badge">&#10003; Powered by SmashCut</div>
