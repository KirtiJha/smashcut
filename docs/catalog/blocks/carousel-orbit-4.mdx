  ...
  <body>
    ...
    >
      <div id="carousel-orbit-4-partA" class="clip" data-start="0" data-duration="6">
        <div data-sc-id="sc-elyu" id="carousel-orbit-4-scaler" class="scaler">
          <div data-sc-id="sc-mi5e" id="carousel-orbit-4-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<InstallCommand command="npx smashcut add carousel-orbit-4" item="carousel-orbit-4" />
