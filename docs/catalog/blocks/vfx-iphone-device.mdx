...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-iphone-device.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-iphone-device.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add vfx-iphone-device" item="vfx-iphone-device" />
...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      // ── Act 1 (0–3.5s): iPhone FRONT — hero close-up showing smashcut.dev
