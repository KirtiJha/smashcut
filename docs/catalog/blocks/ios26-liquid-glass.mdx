...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/ios26-liquid-glass.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/ios26-liquid-glass.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add ios26-liquid-glass" item="ios26-liquid-glass" />
          ...
          <div id="phone-scroll" class="ios-home" style="color: #fff; transform: translateY(0)">
            ...
            <div class="ios-notification-layer">
              ...
              <div id="ios-notification-b" class="ios-notification-card">
                <div class="ios-notification-icon ios-notification-smashcut"></div>
                <div class="ios-notification-copy">
                  <div class="ios-notification-title"><span>SmashCut</span><span>1m</span></div>
        ...
        >
          ...
          >
            ...
            <div style="font-size: 13px; color: rgba(255, 255, 255, 0.4); padding: 0 36px 18px">
              Create videos with HTML — powered by SmashCut
            </div>
