...
<html
  ...
  data-composition-variables='[
    ...
    { "id": "answer1", "type": "string", "role": "content", "label": "Answer paragraph 1", "description": "First streamed paragraph. It names the brand this video promotes and says what that brand does.", "default": "You do not need an editor. SmashCut renders the HTML you already write into deterministic, pixel-perfect video." },
    ...
    { "id": "ecCta", "type": "string", "role": "content", "label": "End-card CTA", "description": "Closing-card button label, which names the brand this video promotes. Use the real name of that brand.", "portrays": ["subject_name"], "default": "Try SmashCut" },
    ...
    { "id": "brandLogo", "type": "image", "role": "content", "label": "Brand logo", "description": "Transparent mark of the brand this video promotes, in the closing-card header.", "portrays": ["subject_logo"], "default": "assets/smashcut-logo-white.svg" }
  ]'
>
  <head>
    <meta charset="UTF-8" />
    ...
    <style>
      * {
      ...
      /* end card: the SmashCut closing card, on the family's dark ground */
      #acr-endcard-inner {
        position: absolute;
        inset: 0;
  ...
  <body>
        ...
        <div id="acr-endcard-inner">
          <div class="acr-stage">
            <img
              ...
              src="assets/smashcut-logo-white.svg"
              alt="Brand logo"
            />
            ...
            <div id="acr-eccta">
              <span class="acr-lbl">Try SmashCut</span
              ><svg
                width="30"
                height="34"
                viewBox="0 0 16 24"
    ...
    <script>
      (function () {
        ...
        /* -------- variables -------- */
        var vars =
          window.__smashcut && typeof window.__smashcut.getVariables === "function"
        ...
        var answer1 = text(
          vars.answer1,
          "You do not need an editor. SmashCut renders the HTML you already write into deterministic, pixel-perfect video.",
          220,
        );
...
<InstallCommand command="npx smashcut add ai-chat-reveal" item="ai-chat-reveal" />
...
| `answer1` | `You do not need an editor. SmashCut renders the HTML you already write into deterministic, pixel-perfect video.` | string | First streamed paragraph. It names the brand this video promotes and says what that brand does. |
...
| `ecCta` | `Try SmashCut` | string | Closing-card button label, which names the brand this video promotes. Use the real name of that brand. |
...
| `brandLogo` | `assets/smashcut-logo-white.svg` | image | Transparent mark of the brand this video promotes, in the closing-card header. |
...
<div
  data-composition-id="ai-chat-reveal"
  data-composition-src="compositions/ai-chat-reveal.html"
  data-variable-values='{"botName":"Assistant","userMessage":"How do I turn my HTML into real video?","answer1":"You do not need an editor. SmashCut renders the HTML you already write into deterministic, pixel-perfect video.","answer2":"It is markup, not magic.","answer3":"What you get out of the box:","bullet1":"A catalog of motion primitives you install and own","bullet2":"GSAP timelines that seek to any frame","bullet3":"4K renders from a single CLI command","ecHeadline":"It's not magic.|It's HTML.","ecSub":"Open-source video rendering — write HTML, ship pixel-perfect video.","ecCta":"Try SmashCut","ecFooter":"HYPERFRAMES.HEYGEN.COM","brandLogo":"assets/smashcut-logo-white.svg"}'
></div>
```
