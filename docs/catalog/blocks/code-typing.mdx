...
<iframe
  ...
  loading="lazy"
  srcDoc={`<!doctype html><html><head><meta charset="utf-8"><style>html,body{margin:0;height:100%;overflow:hidden;background:transparent}smashcut-player{display:block;width:100%;height:100%}</style><script src="https://cdn.jsdelivr.net/npm/@smashcut/player@latest/dist/smashcut-player.global.js"><\/script></head><body><script>fetch("/public/catalog/blocks/code-typing.json").then(function(r){return r.json()}).then(function(d){var p=document.createElement("smashcut-player");p.setAttribute("srcdoc",d.html);p.setAttribute("controls","");p.setAttribute("autoplay","");p.setAttribute("loop","");p.setAttribute("muted","");p.setAttribute("poster","https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/code-typing.png");document.body.appendChild(p)});<\/script></body></html>`}
/>

## Install

<InstallCommand command="npx smashcut add code-typing" item="code-typing" />
...
<html lang="en">
  ...
  <body>
    ...
    <script>
      // sc-code-anim.js — self-contained code-animation engine for SmashCut registry blocks.
      //
      // Reuses Shiki Magic Move's baked output (window.__TOKENS, baked at author time) and
      // drives the animation as a PAUSED GSAP timeline the SmashCut engine seeks per frame —
        ...
        function go() {
          ...
          document.fonts.ready.then(function () {
            ...
            if (typeof window.__scForceTimelineRebind === "function") {
              window.__scForceTimelineRebind(); // re-nest now that we are populated
            }
          });
        }
