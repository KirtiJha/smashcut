...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-liquid-background.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-liquid-background.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add vfx-liquid-background" item="vfx-liquid-background" />
    ...
    >
      ...
      <script>
        ...
        setTimeout(function () {
          ...
          // ── sc-seek integration for Three.js adapter ──
          window.addEventListener("sc-seek", function (e) {
            var t = e.detail.time;
            tl.seek(t);
            uniforms.uTime.value = t;
            renderer.render(scene, camera);
