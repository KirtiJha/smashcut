  ...
  <body>
    ...
    >
      <div id="carousel-path-2-partA" class="clip" data-start="0" data-duration="6">
        <div data-sc-id="sc-elyu" id="carousel-path-2-scaler" class="scaler">
          <div data-sc-id="sc-mi5e" id="carousel-path-2-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<InstallCommand command="npx smashcut add carousel-path-2" item="carousel-path-2" />
