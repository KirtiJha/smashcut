  ...
  <body>
    ...
    >
      <div id="carousel-circle-5-partA" class="clip" data-start="0" data-duration="6">
        <div data-sc-id="sc-elyu" id="carousel-circle-5-scaler" class="scaler">
          <div data-sc-id="sc-mi5e" id="carousel-circle-5-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<InstallCommand command="npx smashcut add carousel-circle-5" item="carousel-circle-5" />
