...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-portal.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/vfx-portal.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add vfx-portal" item="vfx-portal" />
...
<html lang="en">
  ...
  <body>
    ...
    >
      ...
      <!-- Driver clip for SmashCut timeline sync -->
      <div
        id="driver"
        class="clip"
        data-start="0"
