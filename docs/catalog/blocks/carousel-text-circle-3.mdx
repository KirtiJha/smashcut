  ...
  <body>
    ...
    >
      <div id="carousel-text-circle-3-partA" class="clip" data-start="0" data-duration="3">
        <div data-sc-id="sc-elyu" id="carousel-text-circle-3-scaler" class="scaler">
          <div data-sc-id="sc-mi5e" id="carousel-text-circle-3-stage" class="stage"></div>
        </div>
      </div>
...
<InstallCommand command="npx smashcut add carousel-text-circle-3" item="carousel-text-circle-3" />
