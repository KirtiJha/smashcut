...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/hw-write-title.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/hw-write-title.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add hw-write-title" item="hw-write-title" />
