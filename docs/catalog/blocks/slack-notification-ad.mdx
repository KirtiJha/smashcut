...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/slack-notification-ad.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/slack-notification-ad.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add slack-notification-ad" item="slack-notification-ad" />
  ...
  <body>
    ...
    >
      <div
        ...
        data-track-index="1"
      >
        <div data-sc-id="sc-cdmk" class="screen">
          <div data-sc-id="sc-271o" id="sna-wall" data-layout-allow-overflow="">
            <div data-sc-id="sc-bhk8" class="grad"></div>
            <div data-sc-id="sc-h60x" class="grain"></div>
          </div>

          <div data-sc-id="sc-rwb7" id="sna-chrome">
            <div data-sc-id="sc-ow1u" id="sna-statusbar">
              <!-- cellular bars -->
              <svg data-sc-id="sc-0g06" width="18" height="12" viewBox="0 0 18 12" fill="none">
                <rect
                  data-sc-id="sc-8dlt"
                  x="0"
                  y="7.5"
                  ...
                  fill="#fff"
                />
                <rect data-sc-id="sc-neot" x="5" y="5" width="3" height="7" rx="1" fill="#fff" />
                <rect
                  data-sc-id="sc-xbtk"
                  x="10"
                  y="2.5"
                  ...
                  fill="#fff"
                />
                <rect data-sc-id="sc-bygt" x="15" y="0" width="3" height="12" rx="1" fill="#fff" />
              </svg>
              <!-- wifi -->
              <svg data-sc-id="sc-8o46" width="17" height="12" viewBox="0 0 17 12" fill="none">
                <path
                  data-sc-id="sc-0u94"
              ...
              <!-- battery -->
              <svg data-sc-id="sc-890e" width="27" height="13" viewBox="0 0 27 13" fill="none">
                <rect
                  data-sc-id="sc-402j"
                  x="0.5"
                  y="0.5"
                  ...
                  stroke-opacity="0.4"
                />
                <rect data-sc-id="sc-kowz" x="2" y="2" width="20" height="9" rx="2.4" fill="#fff" />
                <path
                  data-sc-id="sc-civj"
            ...
            <div data-sc-id="sc-zh2y" id="sna-lockglyph">
              <svg data-sc-id="sc-xyi2" width="21" height="21" viewBox="0 0 21 21" fill="none">
                <rect
                  data-sc-id="sc-5ez6"
                  x="3.5"
                  y="9"
            ...
            <div data-sc-id="sc-sscr" id="sna-date" data-layout-allow-overlap="">
              Thursday, August 14
            </div>
            <div data-sc-id="sc-vfft" id="sna-clockwrap">
              <div data-sc-id="sc-4x4o" class="clock" data-t="0">9:41</div>
              <div data-sc-id="sc-eb8w" class="clock" data-t="1">9:42</div>
              <div data-sc-id="sc-hfp6" class="clock" data-t="2">9:45</div>
              <div data-sc-id="sc-tj9u" class="clock" data-t="3">9:51</div>
            </div>

            <div data-sc-id="sc-5dr4" class="cornerbtn" id="sna-btn-torch">
              <svg data-sc-id="sc-9ila" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  data-sc-id="sc-33g6"
            ...
            <div data-sc-id="sc-0h7z" class="cornerbtn" id="sna-btn-camera">
              <svg data-sc-id="sc-w3ny" width="21" height="17" viewBox="0 0 21 17" fill="none">
                <path
                  data-sc-id="sc-go8g"
                  ...
                  fill="#fff"
                />
                <circle data-sc-id="sc-z4lk" cx="10.5" cy="9.5" r="3.6" fill="rgba(64,66,78,0.9)" />
                <circle data-sc-id="sc-t33m" cx="10.5" cy="9.5" r="2.5" fill="#fff" />
              </svg>
            </div>
            <div data-sc-id="sc-l2or" id="sna-homebar"></div>
          </div>

          <div data-sc-id="sc-h4bv" id="sna-stack"></div>
        </div>
      </div>
    </div>
