  ...
  <body>
    ...
    <script>
      (function () {
        ...
        // in JS. `window.__smashcut` is NOT guaranteed to exist yet when this
...
<InstallCommand command="npx smashcut add gallery-tunnel" item="gallery-tunnel" />
