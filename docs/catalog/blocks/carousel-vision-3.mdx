  ...
  <body>
    ...
    >
      <div id="carousel-vision-3-partA" class="clip" data-start="0" data-duration="6">
        <div data-sc-id="sc-elyu" id="carousel-vision-3-scaler" class="scaler">
          <div data-sc-id="sc-mi5e" id="carousel-vision-3-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<InstallCommand command="npx smashcut add carousel-vision-3" item="carousel-vision-3" />
