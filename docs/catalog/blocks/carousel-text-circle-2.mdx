  ...
  <body>
    ...
    >
      <div id="carousel-text-circle-2-partA" class="clip" data-start="0" data-duration="3">
        <div data-sc-id="sc-elyu" id="carousel-text-circle-2-scaler" class="scaler">
          <div data-sc-id="sc-mi5e" id="carousel-text-circle-2-stage" class="stage"></div>
        </div>
      </div>
...
<InstallCommand command="npx smashcut add carousel-text-circle-2" item="carousel-text-circle-2" />
