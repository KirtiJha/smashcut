...
<html lang="en">
  ...
  <body>
    ...
    >
      ...
      <!-- Driver clip: gives SmashCut a timed element to own on track 0. -->
      <div
        id="af-drv"
        class="clip"
        data-start="0"
    ...
    <script>
      (function () {
        ...
        var V = (window.__smashcut && window.__smashcut.getVariables()) || {};
        ...
        function raw(id) {
          ...
          var css =
            CS.getPropertyValue("--sc-var-" + slug).trim() ||
...
<InstallCommand command="npx smashcut add vfx-anamorphic-flare" item="vfx-anamorphic-flare" />
