...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/macos-tahoe-liquid-glass.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/blocks/macos-tahoe-liquid-glass.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add macos-tahoe-liquid-glass" item="macos-tahoe-liquid-glass" />
  ...
  <body>
    ...
    <script>
      ...
      function drawFinderWindow(ctx) {
        ...
        ctx.fillText("SmashCut", x + w / 2, y + 25);
        ctx.textAlign = "left";
