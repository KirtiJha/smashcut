...
<!doctype html>
<!--
  browser-device-stage -- SmashCut video primitive (product demo / stage)
...
<InstallCommand command="npx smashcut add browser-device-stage" item="browser-device-stage" />
