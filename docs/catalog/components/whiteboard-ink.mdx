...
<!doctype html>
<!--
  whiteboard-ink: SmashCut video primitive (intros and reveals / ink draw)
        ...
        <script>
          (function () {
            ...
            var resolvedDuration =
              window.__smashcut && window.__smashcut.getDuration
                ? window.__smashcut.getDuration()
                : undefined;
...
<InstallCommand command="npx smashcut add whiteboard-ink" item="whiteboard-ink" />
