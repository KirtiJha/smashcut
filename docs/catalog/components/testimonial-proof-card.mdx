...
<!doctype html>
<!--
  testimonial-proof-card: SmashCut video primitive (proof-stats / testimonial)
...
<InstallCommand command="npx smashcut add testimonial-proof-card" item="testimonial-proof-card" />
