...
<!doctype html>
<!--
  beat-pulse-background: SmashCut video primitive (backgrounds / rhythmic)
...
<InstallCommand command="npx smashcut add beat-pulse-background" item="beat-pulse-background" />
