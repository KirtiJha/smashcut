...
<!doctype html>
<!--
  avatar-cloud: SmashCut video primitive (effects / holdable / prove)
  ...
  window.__smashcut.getVariables(), which merges declarations with host
...
<InstallCommand command="npx smashcut add avatar-cloud" item="avatar-cloud" />
