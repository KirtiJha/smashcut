...
<!doctype html>
<!--
  beat-accent: SmashCut video primitive (effects / burst / emphasize)
  ...
  window.__smashcut.getVariables(), never by parsing document.documentElement,
...
<InstallCommand command="npx smashcut add beat-accent" item="beat-accent" />
