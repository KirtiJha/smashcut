...
<!doctype html>
<!--
  comparison-split: SmashCut video primitive (ui-props / holdable / compare)
  ...
  window.__smashcut.getVariables(), which merges declared defaults with
...
<InstallCommand command="npx smashcut add comparison-split" item="comparison-split" />
