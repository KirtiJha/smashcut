...
<!doctype html>
<!--
  locked-nucleus-orbit: SmashCut video primitive (intros / reveals / orbit)
...
<InstallCommand command="npx smashcut add locked-nucleus-orbit" item="locked-nucleus-orbit" />
