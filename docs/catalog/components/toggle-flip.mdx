...
<!doctype html>
<!--
  toggle-flip -- SmashCut video primitive (ui-props / interaction / demonstrate)
  ...
  skills/smashcut-core/references/sub-compositions.md. The root carries
  ...
  3). Variables are read via window.__smashcut.getVariables() (not by
      ...
      <div id="root" data-composition-id="toggle-flip" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            // above (declared on <html>). window.__smashcut.getVariables()
...
<InstallCommand command="npx smashcut add toggle-flip" item="toggle-flip" />
