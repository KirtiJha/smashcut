...
<!--
  ...
  caret.
    ...
    - text (string, default smashcut add typewriter): the line that types
...
<div
  class="sc-catalog-typewriter"
  data-composition-variables='[
    { "id": "text", "type": "string", "role": "content", "label": "Text", "description": "Line that types itself out character by character.", "default": "smashcut add typewriter" },
...
>
  <span>smashcut add typewriter</span><i></i>
</div>

<style>
  .sc-catalog-typewriter {
    color: var(--sc-type-color, #18181b);
  ...
  .sc-catalog-typewriter span {
    display: inline-block;
    max-width: calc(var(--sc-type-progress, 1) * 100%);
    overflow: hidden;
    white-space: nowrap;
  }
  .sc-catalog-typewriter i {
    display: var(--sc-caret-display, block);
    width: var(--sc-caret-width, 3px);
    height: 42px;
    border-radius: 999px;
    background: var(--sc-type-color, #18181b);
    opacity: var(--sc-caret-opacity, 1);
  }
</style>
...
<script>
  (function () {
    ...
    var roots = document.querySelectorAll(".sc-catalog-typewriter");
    for (var i = 0; i < roots.length; i += 1) {
      var root = roots[i];
      root.style.setProperty("--sc-type-color", tone);
      root.style.setProperty("--sc-caret-width", caret.width);
      root.style.setProperty("--sc-caret-display", caret.display);
...
<!--
  ...
  tl.fromTo('.sc-catalog-typewriter', { '--sc-type-progress': 0 }, { '--sc-type-progress': 1, duration: 1.2, ease: 'steps(28)' }, startTime); tl.to('.sc-catalog-typewriter i', { '--sc-caret-opacity': 0.2, duration: 0.24, repeat: 7, yoyo: true, ease: 'none' }, startTime + 0.2);
-->
```
...
<InstallCommand command="npx smashcut add typewriter" item="typewriter" />
...
| --- | --- | --- | --- |
| `text` | `smashcut add typewriter` | string | Line that types itself out character by character. |
...
<div
  ...
  data-variable-values='{"text":"smashcut add typewriter","tone":"ink","caret":"line"}'
></div>
```
