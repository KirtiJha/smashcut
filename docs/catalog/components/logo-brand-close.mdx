...
<html
  ...
  data-composition-variables='[
    { "id": "wordmark", "type": "string", "role": "content", "label": "Wordmark", "description": "Brand name whose letters cascade into the centered lockup.", "default": "SMASHCUT" },
      ...
      <div id="root" data-composition-id="logo-brand-close" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            if (wordmark.length === 0) wordmark = "SMASHCUT";
            var tagline =
              vars.tagline == null
...
<InstallCommand command="npx smashcut add logo-brand-close" item="logo-brand-close" />
...
| --- | --- | --- | --- |
| `wordmark` | `SMASHCUT` | string | Brand name whose letters cascade into the centered lockup. |
...
<div
  ...
  data-variable-values='{"wordmark":"SMASHCUT","tagline":"Write HTML. Render video.","url":"hyperframes.heygen.com","accent":"green","exit":"none"}'
></div>
```
