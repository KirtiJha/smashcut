...
<!doctype html>
<!--
  spring-stack-shuffle: SmashCut video primitive (product demo / physics)
  ...
  seek-safe); variables come from window.__smashcut.getVariables().
-->
<html
  lang="en"
...
<InstallCommand command="npx smashcut add spring-stack-shuffle" item="spring-stack-shuffle" />
