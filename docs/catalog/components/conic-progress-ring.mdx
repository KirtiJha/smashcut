...
<!doctype html>
<!--
  conic-progress-ring: SmashCut video primitive (data / prove / demonstrate)
  ...
  Compiled-from evidence: smashcut-research-css-gems.md, section 10,
...
<InstallCommand command="npx smashcut add conic-progress-ring" item="conic-progress-ring" />
