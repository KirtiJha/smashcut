...
<html
  ...
  data-composition-variables='[{"id": "brand", "type": "string", "role": "content", "label": "Brand", "description": "Wordmark at the top of the card.", "default": "SmashCut"}, {"id": "proof", "type": "string", "role": "content", "label": "Proof line", "description": "Social-proof line under the stars.", "default": "12,000+ creators"}, {"id": "cta", "type": "string", "role": "content", "label": "CTA", "description": "Label on the closing capsule.", "default": "Start rendering free"}, {"id": "f1", "type": "string", "role": "content", "label": "Feature 1", "description": "First feature, | breaks the line.", "default": "Write|plain HTML"}, {"id": "f2", "type": "string", "role": "content", "label": "Feature 2", "description": "Second feature, | breaks the line.", "default": "Render|pixel-perfect"}, {"id": "f3", "type": "string", "role": "content", "label": "Feature 3", "description": "Third feature, | breaks the line.", "default": "Own|every line"}]'
>
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <template>
      <div id="root" data-composition-id="social-proof-card" data-duration="4" data-fps="30">
        ...
        <div class="spc-stage">
          <div class="spc-brand" id="spc-brand">SmashCut</div>
        ...
        <script>
          (function () {
            ...
            document.getElementById("spc-brand").textContent = text(vars.brand, "SmashCut", 26);
...
<InstallCommand command="npx smashcut add social-proof-card" item="social-proof-card" />
...
| --- | --- | --- | --- |
| `brand` | `SmashCut` | string | Wordmark at the top of the card. |
...
<div
  ...
  data-variable-values='{"brand":"SmashCut","proof":"12,000+ creators","cta":"Start rendering free","f1":"Write|plain HTML","f2":"Render|pixel-perfect","f3":"Own|every line"}'
></div>
```
