...
<!--
  Perspective Marquee - typography primitive for SmashCut.
...
<div
  class="sc-catalog-perspective-marquee"
...
<style>
  .sc-catalog-perspective-marquee {
    color: #18181b;
  ...
  .sc-catalog-perspective-marquee {
    ...
    perspective: 900px;
    overflow: hidden;
    transform: rotateX(var(--sc-marquee-tilt, 18deg));
  }
  .sc-catalog-perspective-marquee div {
    display: inline-flex;
    gap: 22px;
    white-space: nowrap;
    transform: translateX(calc(var(--sc-marquee-x, 0px) * var(--sc-marquee-reach, 1)));
  }
  .sc-catalog-perspective-marquee span {
    padding: 12px 18px;
    border-radius: 999px;
    background: var(--sc-marquee-pill-bg, #18181b);
    color: var(--sc-marquee-pill-fg, #fff);
    font-size: 28px;
...
<script>
  (function () {
    ...
    var roots = document.querySelectorAll(".sc-catalog-perspective-marquee");
    for (var i = 0; i < roots.length; i += 1) {
      roots[i].style.setProperty("--sc-marquee-tilt", tilt);
      roots[i].style.setProperty("--sc-marquee-reach", String(reach));
      roots[i].style.setProperty("--sc-marquee-pill-bg", tone.bg);
      roots[i].style.setProperty("--sc-marquee-pill-fg", tone.fg);
...
<!--
  ...
  tl.fromTo('.sc-catalog-perspective-marquee div', { '--sc-marquee-x': '0px' }, { '--sc-marquee-x': '-360px', duration: 4.5, ease: 'none' }, startTime);
-->
```
...
<InstallCommand command="npx smashcut add perspective-marquee" item="perspective-marquee" />
