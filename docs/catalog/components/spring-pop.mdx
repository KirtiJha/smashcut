...
<!doctype html>
<!--
  spring-pop: SmashCut video primitive (effects / burst / reveal)
  ...
  plus smashcut-animation rules/spring-pop-entrance.md's playful
...
<InstallCommand command="npx smashcut add spring-pop" item="spring-pop" />
