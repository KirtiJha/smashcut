...
<!doctype html>
<!--
  beat-timeline -- SmashCut video primitive (transitions / sequencing / bridge)
  ...
  come from window.__smashcut.getVariables(), because document.documentElement
...
<InstallCommand command="npx smashcut add beat-timeline" item="beat-timeline" />
