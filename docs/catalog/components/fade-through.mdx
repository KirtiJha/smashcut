...
<!--
  ...
  Put class="sc-fade-through-out" on the outgoing layer and
  class="sc-fade-through-in" on the incoming layer. Add the optional wash
  ...
  the CSS above consumes. The timeline recipe below is untouched by them.
    ...
    - wash (paper | white | ink | accent, default paper): the colour of the
      ...
      --sc-fade-through-wash, so an existing override keeps working; accent
      rides --accent.
...
<div
  class="sc-fade-through-wash"
  aria-hidden="true"
  data-composition-variables='[
    { "id": "wash", "type": "enum", "role": "style", "label": "Wash", "description": "Colour of the mid-transition frame. Paper resolves through --sc-fade-through-wash, accent rides --accent.", "default": "paper", "options": [{ "value": "paper", "label": "Paper" }, { "value": "white", "label": "White" }, { "value": "ink", "label": "Ink" }, { "value": "accent", "label": "Accent" }] },
...
<style>
  ...
  .sc-fade-through-wash {
    position: absolute;
    inset: 0;
    opacity: 0;
    pointer-events: none;
    background: var(--sc-fade-through-paint, var(--sc-fade-through-wash, #f8f5ec));
    filter: opacity(var(--sc-fade-through-strength, 1));
    z-index: 900;
  }
</style>
...
<script>
  (function () {
    ...
    var washes = {
      paper: "var(--sc-fade-through-wash, #f8f5ec)",
      white: "#ffffff",
      ink: "#0b0b0f",
    ...
    var overlays = document.querySelectorAll(".sc-fade-through-wash");
    for (var i = 0; i < overlays.length; i += 1) {
      overlays[i].style.setProperty("--sc-fade-through-paint", paint);
      overlays[i].style.setProperty("--sc-fade-through-strength", String(strength));
    }
  })();
</script>
...
<!--
  ...
  tl.to(".sc-fade-through-out", { opacity: 0, duration: 0.45, ease: "power2.inOut" }, startTime);
  tl.to(".sc-fade-through-wash", { opacity: 1, duration: 0.35, ease: "power2.inOut" }, startTime);
  tl.to(".sc-fade-through-wash", { opacity: 0, duration: 0.45, ease: "power2.inOut" }, startTime + 0.35);
  tl.to(".sc-fade-through-in", { opacity: 1, duration: 0.55, ease: "power2.out" }, startTime + 0.35);
-->
```
...
<InstallCommand command="npx smashcut add fade-through" item="fade-through" />
...
| --- | --- | --- | --- |
| `wash` | `paper` | `paper`, `white`, `ink`, `accent` | Colour of the mid-transition frame. Paper resolves through --sc-fade-through-wash, accent rides --accent. |
