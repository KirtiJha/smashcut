...
<!doctype html>
<!--
  multiplayer-cursors, SmashCut video primitive (pointers / loop / prove)
  ...
  window.__smashcut.getVariables(), which owns merged defaults and host
...
<InstallCommand command="npx smashcut add multiplayer-cursors" item="multiplayer-cursors" />
