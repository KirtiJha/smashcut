...
<!doctype html>
<!--
  variable-axis-type -- SmashCut video primitive (typography / burst / emphasize)
  ...
  Compiled-from evidence: smashcut-research-type-svg.md, VariableAxisType.
...
<InstallCommand command="npx smashcut add variable-axis-type" item="variable-axis-type" />
