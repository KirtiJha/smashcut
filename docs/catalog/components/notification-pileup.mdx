...
<!doctype html>
<!--
  notification-pileup, SmashCut video primitive (ui-props / loop / agitate)
  ...
  from window.__smashcut.getVariables(). The hardcoded timeline key stays
...
<InstallCommand command="npx smashcut add notification-pileup" item="notification-pileup" />
