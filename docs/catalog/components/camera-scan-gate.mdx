...
<!doctype html>
<!--
  camera-scan-gate -- SmashCut video primitive (ui-props / interaction / demonstrate)
  ...
  window.__smashcut.getVariables(), which owns declared defaults merged
      ...
      >
        ...
        <script>
          (function () {
            ...
            // owner after mount, window.__smashcut.getVariables().
            var vars =
...
<InstallCommand command="npx smashcut add camera-scan-gate" item="camera-scan-gate" />
