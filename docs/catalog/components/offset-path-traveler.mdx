...
<!doctype html>
<!--
  offset-path-traveler: SmashCut video primitive (product demo / path travel)
...
<InstallCommand command="npx smashcut add offset-path-traveler" item="offset-path-traveler" />
