...
<!doctype html>
<!--
  parallax-device-dive: SmashCut video primitive (camera / device / transition)
...
<InstallCommand command="npx smashcut add parallax-device-dive" item="parallax-device-dive" />
