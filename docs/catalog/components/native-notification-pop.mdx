...
<!--
  ...
  Variables (declared in data-composition-variables below):
    ...
    - app_label (string, default "SmashCut"): small-caps app name row.
...
<html
  ...
  data-composition-variables='[
    ...
    { "id": "app_label", "type": "string", "role": "content", "label": "App label", "description": "Small-caps app name row beside the app dot.", "default": "SmashCut" },
      ...
      <div id="root" data-composition-id="native-notification-pop" data-duration="3" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var appLabel = vars.app_label == null ? "SmashCut" : String(vars.app_label);
...
<InstallCommand command="npx smashcut add native-notification-pop" item="native-notification-pop" />
...
| `app_label` | `SmashCut` | string | Small-caps app name row beside the app dot. |
...
<div
  ...
  data-variable-values='{"title":"Render complete","body":"launch-cut.mp4 is ready to preview","app_label":"SmashCut","os":"ios","at":0.3,"accent":"green","exit":"none"}'
></div>
```
