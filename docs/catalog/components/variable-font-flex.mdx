...
<!doctype html>
<!--
  variable-font-flex: SmashCut video primitive (type / Wave M experiment M5)
...
<InstallCommand command="npx smashcut add variable-font-flex" item="variable-font-flex" />
