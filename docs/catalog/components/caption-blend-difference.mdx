...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/smashcut-oss/docs/images/catalog/components/caption-blend-difference.mp4" poster="https://static.heygen.ai/smashcut-oss/docs/images/catalog/components/caption-blend-difference.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx smashcut add caption-blend-difference" item="caption-blend-difference" />
