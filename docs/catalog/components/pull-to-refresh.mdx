...
<!doctype html>
<!--
  pull-to-refresh: SmashCut video primitive (pointers / interaction / demonstrate)
  ...
  Variables come from window.__smashcut.getVariables(), which owns merged
...
<InstallCommand command="npx smashcut add pull-to-refresh" item="pull-to-refresh" />
