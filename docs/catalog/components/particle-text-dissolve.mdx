...
<!doctype html>
<!--
  particle-text-dissolve: SmashCut video primitive (type / particles).
...
<InstallCommand command="npx smashcut add particle-text-dissolve" item="particle-text-dissolve" />
