...
<!--
  ...
  Variables:
    ...
    - button_label (string, default "Get SmashCut"): CTA capsule label.
...
<html
  ...
  data-composition-variables='[
    ...
    { "id": "button_label", "type": "string", "role": "content", "label": "Button label", "description": "Text displayed inside the CTA capsule.", "default": "Get SmashCut" },
      ...
      <div id="root" data-composition-id="cta-lockup" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var buttonText =
              vars.button_label == null ? "Get SmashCut" : String(vars.button_label);
            var microcopyText =
...
<InstallCommand command="npx smashcut add cta-lockup" item="cta-lockup" />
...
| `button_label` | `Get SmashCut` | string | Text displayed inside the CTA capsule. |
...
<div
  ...
  data-variable-values='{"action_line":"Start building today","button_label":"Get SmashCut","microcopy":"Free while in beta","accent":"green"}'
></div>
```
