...
<!doctype html>
<!--
  vector-editor-rig -- SmashCut video primitive (ui-props / holdable / demonstrate)
  ...
  root. Variables come from window.__smashcut.getVariables(), which merges
...
<InstallCommand command="npx smashcut add vector-editor-rig" item="vector-editor-rig" />
