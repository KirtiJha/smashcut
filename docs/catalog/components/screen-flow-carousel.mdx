...
<!doctype html>
<!--
  screen-flow-carousel -- SmashCut video primitive (product demo / feature tour)
...
<InstallCommand command="npx smashcut add screen-flow-carousel" item="screen-flow-carousel" />
