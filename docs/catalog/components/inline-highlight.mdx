...
<!--
  ...
  Wrap target text with class="sc-inline-highlight". Animate
  --sc-highlight-scale from 0 to 1 on the element.
  ...
  timeline recipe below is untouched by them.
    ...
    - origin (left | right | center, default left): edge the marker grows out of while
      --sc-highlight-scale runs from 0 to 1.

  Setting --sc-highlight-color, --sc-highlight-height or --sc-highlight-origin on an
...
>
  .sc-inline-highlight {
    --sc-highlight-scale: 0;
    position: relative;
    display: inline;
    z-index: 0;
  }
  .sc-inline-highlight::after {
    content: "";
    position: absolute;
    left: -0.08em;
    right: -0.08em;
    bottom: 0.05em;
    height: var(--sc-highlight-height, 0.38em);
    background: var(--sc-highlight-color, #fff06a);
    transform: scaleX(var(--sc-highlight-scale));
    transform-origin: var(--sc-highlight-origin, left center);
    z-index: -1;
  }
</style>
...
<script>
  (function () {
    ...
    root.style.setProperty("--sc-highlight-color", tints[pick(tints, vars.tint, "yellow")]);
    root.style.setProperty(
      "--sc-highlight-height",
      heights[pick(heights, vars.thickness, "standard")],
    );
    root.style.setProperty("--sc-highlight-origin", origins[pick(origins, vars.origin, "left")]);
  })();
</script>
...
<!--
  ...
  tl.to(".sc-inline-highlight", {
    "--sc-highlight-scale": 1,
    duration: 0.55,
    ease: "power2.out",
    stagger: 0.12,
  }, startTime);
...
<InstallCommand command="npx smashcut add inline-highlight" item="inline-highlight" />
