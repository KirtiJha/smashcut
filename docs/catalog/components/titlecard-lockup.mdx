...
<html
  ...
  data-composition-variables='[
    { "id": "wordmark", "type": "string", "role": "content", "label": "Wordmark", "description": "Display wordmark that settles dead-center.", "default": "SMASHCUT" },
      ...
      <div id="root" data-composition-id="titlecard-lockup" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var wordmarkText = readText(vars.wordmark, "SMASHCUT");
...
<InstallCommand command="npx smashcut add titlecard-lockup" item="titlecard-lockup" />
...
| --- | --- | --- | --- |
| `wordmark` | `SMASHCUT` | string | Display wordmark that settles dead-center. |
...
<div
  ...
  data-variable-values='{"wordmark":"SMASHCUT","label":"WRITE HTML. RENDER VIDEO.","kicker":"INTRODUCING","rule":"show","accent":"green","exit":"none"}'
></div>
```
