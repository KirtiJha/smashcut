...
<!doctype html>
<!--
  svg-mask-reveal -- SmashCut video primitive (effects / burst / exhibit)
  ...
  Compiled-from evidence: smashcut-research-css-masks.md, SvgMaskReveal and
...
<InstallCommand command="npx smashcut add svg-mask-reveal" item="svg-mask-reveal" />
