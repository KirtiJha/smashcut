...
>
  <!--
    Device Frame Stage, a SmashCut video primitive.
    ...
    This file is a mountable SmashCut sub-composition (see
    skills/smashcut-core/references/sub-compositions.md): a host
    ...
    (~/dev/smashcut-corpus-data/mobile/device-frame-spec.md), the
    ...
    <template>
      ...
      <script>
        (function () {
          ...
          var vars = Object.assign({}, declared, window.__scVariables || {});
...
<InstallCommand command="npx smashcut add device-frame-stage" item="device-frame-stage" />
