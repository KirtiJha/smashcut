...
<VariablesExplorer
  ...
  variables={[{"id":"wordmark","type":"string","role":"content","label":"Wordmark","description":"Text displayed by the scan effect.","default":"SMASHCUT"},{"id":"band_angle","type":"number","role":"layout","label":"Band angle","description":"Diagonal angle of the distortion band in degrees.","default":12,"min":-30,"max":30,"step":1,"unit":"deg"}]}
>

```html scan-band.html
<!doctype html>
<!--
  scan-band: SmashCut video primitive
  ...
  Variables:
    - wordmark (string, default "SMASHCUT"): displayed text.
...
<html
  ...
  data-composition-variables='[
    { "id": "wordmark", "type": "string", "role": "content", "label": "Wordmark", "description": "Text displayed by the scan effect.", "default": "SMASHCUT" },
      ...
      <div id="root" data-composition-id="scan-band" data-duration="3.5" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var text = vars.wordmark == null ? "SMASHCUT" : String(vars.wordmark);
...
<InstallCommand command="npx smashcut add scan-band" item="scan-band" />
...
| --- | --- | --- | --- |
| `wordmark` | `SMASHCUT` | string | Text displayed by the scan effect. |
...
<div
  ...
  data-variable-values='{"wordmark":"SMASHCUT","band_angle":12}'
></div>
```
