...
<!doctype html>
<!--
  wordmark-tiles: SmashCut video primitive (typography / holdable / reveal)
  ...
  Variables come from window.__smashcut.getVariables(), which supplies the
...
<InstallCommand command="npx smashcut add wordmark-tiles" item="wordmark-tiles" />
