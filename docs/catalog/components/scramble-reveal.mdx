...
<!--
  ...
  Variables:
    - text (string, default "SMASHCUT"): the target string.
...
<html
  ...
  data-composition-variables='[
    { "id": "text", "type": "string", "role": "content", "label": "Text", "description": "Target string that resolves from deterministic wrong glyphs.", "default": "SMASHCUT" },
      ...
      <div id="root" data-composition-id="scramble-reveal" data-duration="3" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var text = vars.text == null ? "SMASHCUT" : String(vars.text);
...
<InstallCommand command="npx smashcut add scramble-reveal" item="scramble-reveal" />
...
| --- | --- | --- | --- |
| `text` | `SMASHCUT` | string | Target string that resolves from deterministic wrong glyphs. |
...
<div
  ...
  data-variable-values='{"text":"SMASHCUT","accent":"green","style":"terminal","exit":"none"}'
></div>
```
