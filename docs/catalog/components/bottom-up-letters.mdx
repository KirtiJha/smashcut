...
<!--
  ...
  Add class="sc-bottom-up-letters" to a plain text element. This script wraps
...
>
  .sc-bottom-up-letters {
    display: inline-block;
  }
  .sc-bottom-up-letters-char {
    display: inline-block;
    opacity: 0;
    transform: translate3d(
      0,
      calc(var(--sc-letters-travel, 0.85em) * var(--sc-letters-direction, 1)),
      0
    );
...
<script>
  (function () {
    ...
    document.querySelectorAll(".sc-bottom-up-letters").forEach((el) => {
      el.style.setProperty("--sc-letters-travel", travel);
      el.style.setProperty("--sc-letters-direction", direction);
      ...
      for (const part of parts) {
        ...
        span.className = "sc-bottom-up-letters-char";
...
<!--
  ...
  tl.to(".sc-bottom-up-letters-char", {
    opacity: 1,
    y: 0,
    duration: 0.48,
    ease: "back.out(1.7)",
...
<InstallCommand command="npx smashcut add bottom-up-letters" item="bottom-up-letters" />
