...
<!doctype html>
<!--
  stop-motion-cadence: SmashCut video primitive (time law, Wave M10 experiment)
...
<InstallCommand command="npx smashcut add stop-motion-cadence" item="stop-motion-cadence" />
