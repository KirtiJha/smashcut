---
title: "Go further with SmashCut"
...
<div className="sc-docs-video-frame">
  <DocsVideo
    title="An existing SmashCut project is revised with an agent, edited in Studio, enriched, checked, and rendered."
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/journey-go-further-v3-v2.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/journey-go-further-v3.jpg"
  />
</div>
...
- [Understand how a SmashCut project works](/concepts)
