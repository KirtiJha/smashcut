...
<Frame caption="Studio prepares a prompt for the selected element; you paste it into your agent chat.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio/ask-agent-v1.jpg"
    alt="SmashCut Studio dialog for copying a prompt about the selected element and project context"
  />
</Frame>
...
Choose **Lint** at the bottom of the left sidebar. Studio opens **SmashCut
...
- [Understand a SmashCut project](/concepts)
