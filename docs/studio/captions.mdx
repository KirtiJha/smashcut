...
<Frame caption="A selected word connects the canvas, caption rail, and the controls that Studio currently saves.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio-captions-panel-v1.jpg"
    alt="SmashCut Studio with one caption word selected, word blocks in the caption rail, and position and transform controls"
  />
</Frame>
