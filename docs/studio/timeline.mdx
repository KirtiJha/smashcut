...
description: "Move, trim, split, align, and inspect clips in SmashCut Studio."
---
...
<Frame caption="The selected clip edge changes its duration while the canvas and neighboring tracks remain visible.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio/timeline-v1.jpg"
    alt="SmashCut Studio timeline with the edge of a selected clip ready to trim"
  />
</Frame>
