...
<Frame caption="The current Variables panel previews values beside the real composition.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio-variables-panel-v1.jpg"
    alt="SmashCut Studio showing a composition beside the Variables panel with Title, Subtitle, and Background inputs"
  />
</Frame>
...
- a ready-to-run `npx smashcut render ... --variables ...` command.
