...
<Frame caption="A selected headline exposes canvas handles and the Design controls that apply to it.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio/canvas-v1.jpg"
    alt="SmashCut Studio with a headline selected on the canvas and its Design controls open"
  />
</Frame>
