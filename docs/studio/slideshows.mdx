...
A slideshow is a live, navigable presentation—not one linear video. The **Slideshow** tab appears when the active composition contains a SmashCut slideshow manifest.

<Frame caption="The Slideshow panel builds the main route from real scenes before optional branches are added.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio-slideshow-panel-v1.jpg"
    alt="SmashCut Studio showing three main-line slides in the Slideshow panel beside the deck timeline"
  />
</Frame>
