...
description: "Open a SmashCut project, understand the workspace, make a safe edit, and finish a version."
---
...
<div className="sc-docs-video-frame">
  <DocsVideo
    title="A narrated tour of a real SmashCut Studio project"
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-front-door-v2.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-front-door-v2.jpg"
  />
</div>

Studio is the visual editor for the same HTML project your agent and the CLI
use. Any SmashCut project opens here without an import or conversion. Open any project folder, then run:
...
<Frame caption="Preview keeps project files, the live frame, the Inspector, and time-based editing in one workspace.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/studio/overview-v1.jpg"
    alt="SmashCut Studio Preview showing project tools, a live composition, the Inspector, and the timeline"
  />
</Frame>
...
<div style={{ maxWidth: "42rem", margin: "1.5rem auto" }}>
  <Frame caption="The canvas selects the visible element; Design exposes the properties Studio can edit safely.">
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-direct-edit-loop-v2.mp4"
      poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-direct-edit-loop-v2.jpg"
      alt="Selecting an element and changing it in SmashCut Studio"
      aria-label="Selecting an element and changing it in SmashCut Studio"
      autoPlay
      muted
      loop
      playsInline
...
<div style={{ maxWidth: "42rem", margin: "1.5rem auto" }}>
  <Frame caption="Timing changes stay visible beside the frame and neighboring tracks.">
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-timing-loop-v2.mp4"
      poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-timing-loop-v2.jpg"
      alt="Adjusting clip timing in the SmashCut Studio timeline"
      aria-label="Adjusting clip timing in the SmashCut Studio timeline"
      autoPlay
      muted
      loop
      playsInline
...
<div style={{ maxWidth: "42rem", margin: "1.5rem auto" }}>
  <Frame caption="Studio queues and monitors a render from the same project.">
    <video
      src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-check-render-loop-v2.mp4"
      poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-check-render-loop-v2.jpg"
      alt="Queuing and monitoring a render in SmashCut Studio"
      aria-label="Queuing and monitoring a render in SmashCut Studio"
      autoPlay
      muted
      loop
      playsInline
