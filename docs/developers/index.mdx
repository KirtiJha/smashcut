---
title: "Build on SmashCut"
sidebarTitle: "Developers"
description: "Choose the smallest SmashCut surface for automation, editing, playback, rendering, or generated compositions."
---
...
<div className="sc-docs-video-frame">
  <DocsVideo
    title="A SmashCut composition shown through the CLI, SDK, Player, and rendering infrastructure."
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/journey-developers-v3-v2.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/journey-developers-v3.jpg"
  />
</div>

Use this path when you want to write a composition yourself, automate a project,
or add SmashCut to another product. If you only want an agent to make a
...
```bash
npx smashcut init my-video --example blank
cd my-video
...
## Add SmashCut to an application
