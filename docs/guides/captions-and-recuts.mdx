...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/captions-recut-demo-v1.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/captions-recut-demo-v1.jpg"
/>
...
```text
Using /smashcut, add clear animated captions to assets/interview.mp4.
...
This page covers two workflows. `/smashcut` picks between them from what you
...
- **Captions:** the intended format and any names or terms the transcript may miss. SmashCut can recommend a visual treatment after it sees the clip.
