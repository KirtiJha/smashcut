...
description: "Bring Figma designs into SmashCut — frozen assets, brand tokens, editable components, storyboard reconstruction, and Figma Motion timelines translated to GSAP."
---

import { DocsVideo } from "/snippets/docs-video.jsx";

Import the parts of a Figma design that should survive into the project: assets,
brand values, editable components, motion, or storyboard states. SmashCut
...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/figma-to-html-demo-v1.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/figma-to-html-demo-v1.jpg"
/>
...
| --- | --- | --- |
| **Static assets** | A frame/layer rendered to SVG/PNG/JPG/PDF, frozen under `.media/` | `smashcut figma asset` |
| **Brand tokens** | Figma variables/styles as composition brand variables | `smashcut figma tokens` or the `/figma` skill via a Figma connector |
| **Components** | A frame as editable HTML with brand-linked colors | `smashcut figma component` |
...
Needed for anything you run from the `smashcut figma` CLI.
...
```bash
smashcut figma asset 'https://www.figma.com/design/KEY/Title?node-id=1-2'
```
...
```bash
smashcut figma component 'https://www.figma.com/design/KEY/Title?node-id=10-20'
```
