...
SmashCut has three official hosting templates. Each one previews a bundled
composition in `<smashcut-player>` and renders it to MP4 on server-side
Chrome and FFmpeg.
...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/render-targets-demo-v1.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/render-targets-demo-v1.jpg"
/>
...
a prepared Sandbox, runs `smashcut render`, uploads the MP4 to Blob, and
returns a public URL.

[Deploy the Vercel template](https://vercel.com/new/clone?demo-title=SmashCut+on+Vercel&demo-description=Preview+HTML+video+compositions+in+the+browser+and+render+MP4s+server-side+on+Vercel+Sandbox.&demo-image=https%3A%2F%2Fraw.githubusercontent.com%2Fheygen-com%2Fsmashcut-vercel-template%2Fmain%2Fdocs%2Fpreview.png&demo-url=https%3A%2F%2Fsmashcut-on-vercel.vercel.app&from=templates&project-name=smashcut-on-vercel&repository-name=smashcut-on-vercel&repository-url=https%3A%2F%2Fgithub.com%2Fheygen-com%2Fsmashcut-vercel-template&stores=%5B%7B%22type%22%3A%22blob%22%2C%22access%22%3A%22public%22%7D%5D)
