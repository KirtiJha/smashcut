...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/motion-graphics-demo-v1.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/motion-graphics-demo-v1.jpg"
/>
...
```text
Using /smashcut, make a six-second motion graphic that counts from zero to
...
<Frame caption="A complete year-in-review graphic. It uses music and sound, but no narration; the motion carries it.">
  <DocsVideo
    ...
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/full-hypecard.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/wfv2-motion.jpg"
  />
</Frame>
