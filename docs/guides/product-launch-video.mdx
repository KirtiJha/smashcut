...
Give SmashCut the real URL when the product, website, or brand should appear in the result.

<DocsVideo
  title="A launch film built by this workflow from huly.io, end to end"
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/product-launch-huly-v5.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/product-launch-huly-v5.jpg"
/>
...
```text
Using /smashcut, make a 30-second launch video for https://example.com.
```
...
SmashCut can animate captured product material or rebuild only the part that needs to move. A raw screen recording is not the default.
