...
1. Give the tool the SmashCut instruction file and your brand material.
...
[Claude Design instruction](https://github.com/heygen-com/hyperframes/blob/main/docs/guides/claude-design-smashcut.md) · [Open Design handoff](https://github.com/heygen-com/hyperframes/blob/main/docs/guides/open-design-smashcut.md)
