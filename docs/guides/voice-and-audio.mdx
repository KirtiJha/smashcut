...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/voice-audio-demo-v2.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/voice-audio-demo-v2.jpg"
/>
...
```bash
npx smashcut transcribe interview.mp4
```
...
```bash
npx smashcut transcribe interview.mp4 --language es
```
...
```bash
npx smashcut transcribe interview.mp4 --engine whisper --model medium.en
npx smashcut transcribe interview.mp4 --engine whisper --model large-v3
```
