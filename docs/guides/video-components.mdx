...
description: "Import, place, replace, trim, and review images and footage in a SmashCut project."
---
...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/media-basics-demo-v1.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/media-basics-demo-v1.jpg"
/>
...
the project, keep filenames stable, and run `npx smashcut check` before
rendering.
...
<Frame caption="Current Studio, changing the real project: inspect the source, change Fit and Position, crop on the canvas, then import another local asset.">
  <video
    ...
    playsInline
    preload="metadata"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-media-edit-loop-v1.jpg"
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/studio-media-edit-loop-v4.mp4"
  />
</Frame>
