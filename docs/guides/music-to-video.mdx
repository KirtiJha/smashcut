...
<Frame caption="A complete music-driven film. Its sections, visual treatments, and cuts follow the track.">
  <DocsVideo
    ...
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/full-music-v2.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/wfv2-music.jpg"
  />
</Frame>
...
```text
Using /smashcut, turn assets/song.wav and the photos in assets/tour into a
...
SmashCut maps the track’s phrases, energy, onsets, silences, rolls, drops, and hard stops before it plans the visuals.
