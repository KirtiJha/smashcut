...
```text
Run the SmashCut checks, fix any failures, and show me the final preview.
...
one person to manage the complete finish. SmashCut creation workflows wait
