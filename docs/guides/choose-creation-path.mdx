...
description: "Four places to make a SmashCut video, and how to tell which one is yours."
---

There are four places to make a SmashCut video. They all give you a video.
...
The hosted SmashCut connector (an MCP connector — a plug-in an AI chat can
use) builds and renders through your HeyGen account. You give up the project
folder, Studio, and local rendering.

[Connect SmashCut to an AI chat →](/guides/mcp)
