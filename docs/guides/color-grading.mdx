...
<Frame caption="The same source before and after a restrained natural-portrait grade.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/color-grading-before-after-v1.png"
...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/color-grading-demo-v1.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/color-grading-demo-v1.jpg"
/>
...
```bash
npx smashcut grade-compare --for frame.png --grades grades.json
```
...
npx smashcut media-treatment --selector '#interview' --analyze --json
```
...
SmashCut reads a 3D `.cube` file up to 64 points per side and blends it in at
an intensity you set.

Nothing normalizes your footage first — SmashCut does not identify camera
...
nothing at all; `npx smashcut lint` catches it and names the section the
control belongs in.
