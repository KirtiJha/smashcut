...
The normal timeline methods are `to()`, `from()`, `fromTo()`, and `set()`. GSAP supports many CSS properties, but the [SmashCut animation skill](https://github.com/KirtiJha/smashcut/tree/main/skills/smashcut-animation) contains the render-safe patterns used by agents.
