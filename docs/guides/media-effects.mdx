...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/media-effects-showcase-v2.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/media-effects-showcase-v2.jpg"
/>
...
<Frame caption="One source, four finishes: original, pixelated, two-ink print, and ASCII.">
  <img
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/media-effects-grid-v1.png"
...
npx smashcut media-treatment --capability twoInkPrint --json
```

Then apply it:

```bash
npx smashcut media-treatment \
  --selector '#product' \
