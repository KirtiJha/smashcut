...
<DocsVideo
  ...
  src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/render-performance-demo-v2.mp4"
  poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/render-performance-demo-v2.jpg"
/>
...
```bash
npx smashcut render --format webm --vp9-cpu-used 2 --output overlay.webm
```
