...
<Frame caption="A complete launch film about timeline editing. The custom route combines the story, product evidence, motion, voice, music, and sound.">
  <DocsVideo
    ...
    src="https://static.heygen.ai/smashcut-oss/docs/images/showcase/full-timeline.mp4"
    poster="https://static.heygen.ai/smashcut-oss/docs/images/showcase/general-video-timing-v1.jpg"
  />
</Frame>
...
```text
Using /smashcut, make a one-minute recruiting film from the interview clips
