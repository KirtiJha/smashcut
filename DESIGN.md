# SmashCut Design System & Style Guide

Use this guide to configure Mintlify docs or any other platform to match the SmashCut brand.
...
- **No heavy shadows** — SmashCut uses a flat, minimal aesthetic
...
- **Logo**: "SmashCut" in `--font-display` at 600 weight
