...
| `grade` | SmashCut color-grading blocks | Core preset → look index params/CDN LUT → deterministic cube |
...
Most SmashCut projects already have assets in `assets/`. media-use adopts them:
