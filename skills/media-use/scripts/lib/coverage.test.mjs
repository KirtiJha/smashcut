...
// Capstone: media-use must actually OWN each smashcut media weakness. This
...
test("weakness: scattered audio engine → consolidated under media-use (smashcut-media gone)", () => {
