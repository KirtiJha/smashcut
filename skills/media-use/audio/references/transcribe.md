...
```bash
npx smashcut transcribe audio.mp3  --model small.en             # known English
npx smashcut transcribe video.mp4  --model small --language es  # known Spanish
npx smashcut transcribe audio.mp3  --model small                # unknown language (auto-detect)
npx smashcut transcribe subtitles.srt                           # import existing
npx smashcut transcribe subtitles.vtt
npx smashcut transcribe openai-response.json
```
