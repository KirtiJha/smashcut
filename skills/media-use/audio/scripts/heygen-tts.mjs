...
// filtering live in exactly one place. Bypasses the `smashcut` CLI, which in
...
if (wordsPath) {
  if (words && words.length) {
    ...
    console.error("⚠ no word_timestamps in response — run `smashcut transcribe` instead");
  }
}
