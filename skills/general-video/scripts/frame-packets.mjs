...
// Thin wrapper over the shared packet builder in smashcut-core — this file pins
...
// one owner: ../../smashcut-core/scripts/lib/frame-packets-core.mjs

import { existsSync } from "node:fs";
import { dirname, join, resolve } from "node:path";
import { fileURLToPath } from "node:url";
import * as core from "../../smashcut-core/scripts/lib/frame-packets-core.mjs";
...
const CONFIG = {
  animationDir: resolve(SKILL_DIR, "../smashcut-animation"),
  corePath: resolve(SKILL_DIR, "../smashcut-core/references/frame-worker-core.md"),
