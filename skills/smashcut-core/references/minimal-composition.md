...
The smallest renderable SmashCut composition — a standalone (top-level) root with one clip and one tween:
...
<html lang="en">
  <head>
    ...
    <title>Minimal SmashCut Composition</title>
