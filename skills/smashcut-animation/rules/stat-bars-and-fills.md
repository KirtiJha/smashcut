...
- **One accent hue, consistent blueprint** — see `smashcut-creative/references/data-in-motion.md`.

## See also

`counting-dynamic-scale` (the number beside the graphic — same ease/duration) · `svg-path-draw` (progress-ring draw mechanics) · `smashcut-creative/references/data-in-motion.md` (stat layout + visual weight).
