#!/usr/bin/env node
// animation-map.mjs — SmashCut animation map for agents
//
...
const packages = await importPackagesOrBootstrap(
  ["@smashcut/producer", "@smashcut/core", "@smashcut/core/compiler"],
  {
    npmPackages: [
...
const OUT_DIR = resolve(args.out ?? ".smashcut/anim-map");
