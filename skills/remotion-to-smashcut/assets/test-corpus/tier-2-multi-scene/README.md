...
The scene crossfading is a SmashCut idiom, not a Remotion one: at scene boundaries
...
# 3. Render SmashCut translation
cd ../sc-src && npx smashcut render --output ../hf.mp4
