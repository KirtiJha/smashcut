...
| `staticFile("x.png")`                  | `"assets/x.png"` — copy the file into `sc-src/assets/` next to `index.html` |
...
| Remotion                        | SmashCut                                                                                                       |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `<Lottie animationData={data}>` | `<div id="lottie-N">` + `<script>const anim = lottie.loadAnimation({...}); window.__scLottie.push(anim)</script>` |
