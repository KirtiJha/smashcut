...
| `clockWipe()`                      | use HF's `sdf-iris` shader-transition (`npx smashcut add sdf-iris`)                    |
...
```bash
npx smashcut add sdf-iris
```

Then in the composition:

```html
<div id="iris-transition" class="sc-shader-transition" data-start="1.5" data-duration="0.5">
