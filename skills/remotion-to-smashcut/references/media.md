...
`sc-src/assets/x`. Multiple files can be batched with a setup script;
...
[smashcut-vs-remotion.mdx](https://github.com/heygen-com/hyperframes/blob/main/docs/guides/smashcut-vs-remotion.mdx)
for details.
