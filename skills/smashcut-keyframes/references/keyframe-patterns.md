...
window.__scAnime.push(animation);
```
...
| Imported model      | Model animation must scrub deterministically   | `AnimationMixer.setTime`, camera, material, lights                 | Three AnimationMixer                       | drive from SmashCut time; `--ghost`         |
