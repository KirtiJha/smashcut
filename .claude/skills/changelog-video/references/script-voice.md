...
- Open with the week + the marquee, close with the digest pointer
  ("See everything at smashcut dot heygen dot com").
...
```json
{
  "lines": [
    {
      "id": "l1",
      "tokens": ["This", "week", "at", "SmashCut,", { "display": "JSON", "spoken": "jay-sawn" }]
    }
  ]
}
```
...
5. **URLs**: `hyperframes.heygen.com → "smashcut dot hey-jen dot com"`.
